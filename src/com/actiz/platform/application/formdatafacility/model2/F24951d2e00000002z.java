...
* Author      :Actiz
* Build Time  :2017-06-15 13:57:59.213
*/
...
public class F24951d2e00000002z implements IAppEntityObject{
	private Long atznianjia_id;
	
			 		private Long atznianjia_actizversion;
					 			 		private Long atznianjia_ygid;
					 		private String atznianjia_niandu = "";
					 		private Double atznianjia_tianshu = 0.0;
					 		private Date atznianjia_jiezhiriqi;
					 		private Double atznianjia_syts = 0.0;
					 		private String atznianjia_lurur = "";
					 		private Date atznianjia_lururq;
					 		private Long atznianjia_lururid;
					 		...
					 		public void setAtznianjia_actizversion(Long atznianjia_actizversion){
			this.atznianjia_actizversion = atznianjia_actizversion;
		}
			 	public Long getAtznianjia_actizversion(){
	  		return atznianjia_actizversion;
	  	}
	    		   		 		public void setAtznianjia_ygid(Long atznianjia_ygid){
			this.atznianjia_ygid = atznianjia_ygid;
		}
			 	public Long getAtznianjia_ygid(){
	  		return atznianjia_ygid;
	  	}
	    		 		public void setAtznianjia_niandu(String atznianjia_niandu){
			this.atznianjia_niandu = atznianjia_niandu;
		}
			 	public String getAtznianjia_niandu(){
	  		return atznianjia_niandu;
	  	}
	    		 		public void setAtznianjia_tianshu(Double atznianjia_tianshu){
			this.atznianjia_tianshu = atznianjia_tianshu;
		}
			 	public Double getAtznianjia_tianshu(){
	  		return atznianjia_tianshu;
	  	}
	    		 		public void setAtznianjia_jiezhiriqi(Date atznianjia_jiezhiriqi){
			this.atznianjia_jiezhiriqi = atznianjia_jiezhiriqi;
		}
			 	public Date getAtznianjia_jiezhiriqi(){
	  		return atznianjia_jiezhiriqi;
	  	}
	    		 		public void setAtznianjia_syts(Double atznianjia_syts){
			this.atznianjia_syts = atznianjia_syts;
		}
			 	public Double getAtznianjia_syts(){
	  		return atznianjia_syts;
	  	}
	    		 		public void setAtznianjia_lurur(String atznianjia_lurur){
			this.atznianjia_lurur = atznianjia_lurur;
		}
			 	public String getAtznianjia_lurur(){
	  		return atznianjia_lurur;
	  	}
	    		 		public void setAtznianjia_lururq(Date atznianjia_lururq){
			this.atznianjia_lururq = atznianjia_lururq;
		}
			 	public Date getAtznianjia_lururq(){
	  		return atznianjia_lururq;
	  	}
	    		 		public void setAtznianjia_lururid(Long atznianjia_lururid){
			this.atznianjia_lururid = atznianjia_lururid;
		}
			 	public Long getAtznianjia_lururid(){
	  		return atznianjia_lururid;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtznianjia_id(){
  	  	return atznianjia_id;
  	  }
  	  public void setAtznianjia_id(Long atznianjia_id){
  	  	this.atznianjia_id = atznianjia_id;
  	  }
	  public Long getId(){
	  	return getAtznianjia_id();
	  }
