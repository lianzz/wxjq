...
* Author      :Actiz
* Build Time  :2017-06-15 13:48:50.485
*/
...
public class F95ccc3fd00000007z implements IAppEntityObject{
	private Long atzpeixunjl_id;
	
			 		private Long atzpeixunjl_actizversion;
					 			 		private Long atzpeixunjl_kecheng;
					 		private String atzpeixunjl_kechengmc = "";
					 		private Long atzpeixunjl_jiangshiid;
					 		private String atzpeixunjl_jiangshi = "";
					 		private String atzpeixunjl_peixunxs = "";
					 		private Double atzpeixunjl_peixunfy = 0.0;
					 		private Double atzpeixunjl_peixunsc = 0.0;
					 		private String atzpeixunjl_peixundx = "";
					 		private Integer atzpeixunjl_renshu = 0;
					 		private String atzpeixunjl_kejiankfsj = "";
					 		private Timestamp atzpeixunjl_peixunkssj;
					 		private Timestamp atzpeixunjl_peixunjssj;
					 		private String atzpeixunjl_didian = "";
					 		private String atzpeixunjl_kejian;
					 		private String atzpeixunjl_jiangshipj;
					 		private Long atzpeixunjl_lururid;
					 		private String atzpeixunjl_lurur = "";
					 		private Date atzpeixunjl_lururq;
					 		private Long atzpeixunjl_zuihouxgrid;
					 		private String atzpeixunjl_zuihouxgr = "";
					 		private Date atzpeixunjl_zuihouxgrq;
					 		...
					 		public void setAtzpeixunjl_actizversion(Long atzpeixunjl_actizversion){
			this.atzpeixunjl_actizversion = atzpeixunjl_actizversion;
		}
			 	public Long getAtzpeixunjl_actizversion(){
	  		return atzpeixunjl_actizversion;
	  	}
	    		   		 		public void setAtzpeixunjl_kecheng(Long atzpeixunjl_kecheng){
			this.atzpeixunjl_kecheng = atzpeixunjl_kecheng;
		}
			 	public Long getAtzpeixunjl_kecheng(){
	  		return atzpeixunjl_kecheng;
	  	}
	    		 		public void setAtzpeixunjl_kechengmc(String atzpeixunjl_kechengmc){
			this.atzpeixunjl_kechengmc = atzpeixunjl_kechengmc;
		}
			 	public String getAtzpeixunjl_kechengmc(){
	  		return atzpeixunjl_kechengmc;
	  	}
	    		 		public void setAtzpeixunjl_jiangshiid(Long atzpeixunjl_jiangshiid){
			this.atzpeixunjl_jiangshiid = atzpeixunjl_jiangshiid;
		}
			 	public Long getAtzpeixunjl_jiangshiid(){
	  		return atzpeixunjl_jiangshiid;
	  	}
	    		 		public void setAtzpeixunjl_jiangshi(String atzpeixunjl_jiangshi){
			this.atzpeixunjl_jiangshi = atzpeixunjl_jiangshi;
		}
			 	public String getAtzpeixunjl_jiangshi(){
	  		return atzpeixunjl_jiangshi;
	  	}
	    		 		public void setAtzpeixunjl_peixunxs(String atzpeixunjl_peixunxs){
			this.atzpeixunjl_peixunxs = atzpeixunjl_peixunxs;
		}
			 	public String getAtzpeixunjl_peixunxs(){
	  		return atzpeixunjl_peixunxs;
	  	}
	    		 		public void setAtzpeixunjl_peixunfy(Double atzpeixunjl_peixunfy){
			this.atzpeixunjl_peixunfy = atzpeixunjl_peixunfy;
		}
			 	public Double getAtzpeixunjl_peixunfy(){
	  		return atzpeixunjl_peixunfy;
	  	}
	    		 		public void setAtzpeixunjl_peixunsc(Double atzpeixunjl_peixunsc){
			this.atzpeixunjl_peixunsc = atzpeixunjl_peixunsc;
		}
			 	public Double getAtzpeixunjl_peixunsc(){
	  		return atzpeixunjl_peixunsc;
	  	}
	    		 		public void setAtzpeixunjl_peixundx(String atzpeixunjl_peixundx){
			this.atzpeixunjl_peixundx = atzpeixunjl_peixundx;
		}
			 	public String getAtzpeixunjl_peixundx(){
	  		return atzpeixunjl_peixundx;
	  	}
	    		 		public void setAtzpeixunjl_renshu(Integer atzpeixunjl_renshu){
			this.atzpeixunjl_renshu = atzpeixunjl_renshu;
		}
			 	public Integer getAtzpeixunjl_renshu(){
	  		return atzpeixunjl_renshu;
	  	}
	    		 		public void setAtzpeixunjl_kejiankfsj(String atzpeixunjl_kejiankfsj){
			this.atzpeixunjl_kejiankfsj = atzpeixunjl_kejiankfsj;
		}
			 	public String getAtzpeixunjl_kejiankfsj(){
	  		return atzpeixunjl_kejiankfsj;
	  	}
	    		 		public void setAtzpeixunjl_peixunkssj(Timestamp atzpeixunjl_peixunkssj){
			this.atzpeixunjl_peixunkssj = atzpeixunjl_peixunkssj;
		}
			 	public Timestamp getAtzpeixunjl_peixunkssj(){
	  		return atzpeixunjl_peixunkssj;
	  	}
	    		 		public void setAtzpeixunjl_peixunjssj(Timestamp atzpeixunjl_peixunjssj){
			this.atzpeixunjl_peixunjssj = atzpeixunjl_peixunjssj;
		}
			 	public Timestamp getAtzpeixunjl_peixunjssj(){
	  		return atzpeixunjl_peixunjssj;
	  	}
	    		 		public void setAtzpeixunjl_didian(String atzpeixunjl_didian){
			this.atzpeixunjl_didian = atzpeixunjl_didian;
		}
			 	public String getAtzpeixunjl_didian(){
	  		return atzpeixunjl_didian;
	  	}
	    		 		public void setAtzpeixunjl_kejian(String atzpeixunjl_kejian){
			this.atzpeixunjl_kejian = atzpeixunjl_kejian;
		}
			 	public String getAtzpeixunjl_kejian(){
	  		return atzpeixunjl_kejian;
	  	}
	    		 		public void setAtzpeixunjl_jiangshipj(String atzpeixunjl_jiangshipj){
			this.atzpeixunjl_jiangshipj = atzpeixunjl_jiangshipj;
		}
			 	public String getAtzpeixunjl_jiangshipj(){
	  		return atzpeixunjl_jiangshipj;
	  	}
	    		 		public void setAtzpeixunjl_lururid(Long atzpeixunjl_lururid){
			this.atzpeixunjl_lururid = atzpeixunjl_lururid;
		}
			 	public Long getAtzpeixunjl_lururid(){
	  		return atzpeixunjl_lururid;
	  	}
	    		 		public void setAtzpeixunjl_lurur(String atzpeixunjl_lurur){
			this.atzpeixunjl_lurur = atzpeixunjl_lurur;
		}
			 	public String getAtzpeixunjl_lurur(){
	  		return atzpeixunjl_lurur;
	  	}
	    		 		public void setAtzpeixunjl_lururq(Date atzpeixunjl_lururq){
			this.atzpeixunjl_lururq = atzpeixunjl_lururq;
		}
			 	public Date getAtzpeixunjl_lururq(){
	  		return atzpeixunjl_lururq;
	  	}
	    		 		public void setAtzpeixunjl_zuihouxgrid(Long atzpeixunjl_zuihouxgrid){
			this.atzpeixunjl_zuihouxgrid = atzpeixunjl_zuihouxgrid;
		}
			 	public Long getAtzpeixunjl_zuihouxgrid(){
	  		return atzpeixunjl_zuihouxgrid;
	  	}
	    		 		public void setAtzpeixunjl_zuihouxgr(String atzpeixunjl_zuihouxgr){
			this.atzpeixunjl_zuihouxgr = atzpeixunjl_zuihouxgr;
		}
			 	public String getAtzpeixunjl_zuihouxgr(){
	  		return atzpeixunjl_zuihouxgr;
	  	}
	    		 		public void setAtzpeixunjl_zuihouxgrq(Date atzpeixunjl_zuihouxgrq){
			this.atzpeixunjl_zuihouxgrq = atzpeixunjl_zuihouxgrq;
		}
			 	public Date getAtzpeixunjl_zuihouxgrq(){
	  		return atzpeixunjl_zuihouxgrq;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzpeixunjl_id(){
  	  	return atzpeixunjl_id;
  	  }
  	  public void setAtzpeixunjl_id(Long atzpeixunjl_id){
  	  	this.atzpeixunjl_id = atzpeixunjl_id;
  	  }
	  public Long getId(){
	  	return getAtzpeixunjl_id();
	  }
