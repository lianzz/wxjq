...
* Author      :Actiz
* Build Time  :2017-12-11 15:30:29.143
*/
...
import java.sql.Blob;
	public class F55f28b6b00000003z implements IAppEntityObject{
	private Long atzxiangmu_id;
			 		...
			 		private Long atzemployee_id;
					 		...
					 		private Long atzxiangmu_actizversion;
					 		...
					 		private String atzxiangmu_guishugs = "";
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    		 		...
	    		 		public void setAtzxiangmu_actizversion(Long atzxiangmu_actizversion){
			this.atzxiangmu_actizversion = atzxiangmu_actizversion;
		}
			 	public Long getAtzxiangmu_actizversion(){
	  		return atzxiangmu_actizversion;
	  	}
			...
			this.atzxiangmu_zuihouxgrid = atzxiangmu_zuihouxgrid;
	  		...
	  		return atzxiangmu_zuihouxgrid;
	    		 		...
	    		 		public void setAtzxiangmu_guishugs(String atzxiangmu_guishugs){
			this.atzxiangmu_guishugs = atzxiangmu_guishugs;
		}
			 	public String getAtzxiangmu_guishugs(){
	  		return atzxiangmu_guishugs;
	  	}
