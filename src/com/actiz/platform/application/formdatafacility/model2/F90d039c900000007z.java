...
* Author      :Actiz
* Build Time  :2017-11-28 16:02:58.758
*/
...
public class F90d039c900000007z implements IAppEntityObject{
	private Long atzjidukh_id;
	
			 		private Long atzjidukh_actizversion;
					 			 		private Long atzjidukh_jidukhhzid;
					 		private String atzjidukh_jidukhbh = "";
					 		private String atzjidukh_bumen = "";
					 		private String atzjidukh_nianfen = "";
					 		private String atzjidukh_kaohejd = "1";
					 		private String atzjidukh_beikhrxm = "";
					 		private String atzjidukh_gonghao = "";
					 		private String atzjidukh_beikhrgw = "";
					 		private String atzjidukh_kaohergw = "";
					 		private Date atzjidukh_kaohekssj;
					 		private Date atzjidukh_kaohejssj;
					 		private Double atzjidukh_renwuwczpdf = 0.0;
					 		private Double atzjidukh_renwuwczgpf = 0.0;
					 		private Double atzjidukh_jiduzpdf = 0.0;
					 		private Double atzjidukh_zongpingdf = 0.0;
					 		private String atzjidukh_beizhu = "";
					 		private Long atzjidukh_kaohrxm;
					 		private String atzjidukh_zuihouxgr = "";
					 		private Date atzjidukh_zuihouxgrq;
					 		...
					 		public void setAtzjidukh_actizversion(Long atzjidukh_actizversion){
			this.atzjidukh_actizversion = atzjidukh_actizversion;
		}
			 	public Long getAtzjidukh_actizversion(){
	  		return atzjidukh_actizversion;
	  	}
	    		   		 		public void setAtzjidukh_jidukhhzid(Long atzjidukh_jidukhhzid){
			this.atzjidukh_jidukhhzid = atzjidukh_jidukhhzid;
		}
			 	public Long getAtzjidukh_jidukhhzid(){
	  		return atzjidukh_jidukhhzid;
	  	}
	    		 		public void setAtzjidukh_jidukhbh(String atzjidukh_jidukhbh){
			this.atzjidukh_jidukhbh = atzjidukh_jidukhbh;
		}
			 	public String getAtzjidukh_jidukhbh(){
	  		return atzjidukh_jidukhbh;
	  	}
	    		 		public void setAtzjidukh_bumen(String atzjidukh_bumen){
			this.atzjidukh_bumen = atzjidukh_bumen;
		}
			 	public String getAtzjidukh_bumen(){
	  		return atzjidukh_bumen;
	  	}
	    		 		public void setAtzjidukh_nianfen(String atzjidukh_nianfen){
			this.atzjidukh_nianfen = atzjidukh_nianfen;
		}
			 	public String getAtzjidukh_nianfen(){
	  		return atzjidukh_nianfen;
	  	}
	    		 		public void setAtzjidukh_kaohejd(String atzjidukh_kaohejd){
			this.atzjidukh_kaohejd = atzjidukh_kaohejd;
		}
			 	public String getAtzjidukh_kaohejd(){
	  		return atzjidukh_kaohejd;
	  	}
	    		 		public void setAtzjidukh_beikhrxm(String atzjidukh_beikhrxm){
			this.atzjidukh_beikhrxm = atzjidukh_beikhrxm;
		}
			 	public String getAtzjidukh_beikhrxm(){
	  		return atzjidukh_beikhrxm;
	  	}
	    		 		public void setAtzjidukh_gonghao(String atzjidukh_gonghao){
			this.atzjidukh_gonghao = atzjidukh_gonghao;
		}
			 	public String getAtzjidukh_gonghao(){
	  		return atzjidukh_gonghao;
	  	}
	    		 		public void setAtzjidukh_beikhrgw(String atzjidukh_beikhrgw){
			this.atzjidukh_beikhrgw = atzjidukh_beikhrgw;
		}
			 	public String getAtzjidukh_beikhrgw(){
	  		return atzjidukh_beikhrgw;
	  	}
	    		 		public void setAtzjidukh_kaohergw(String atzjidukh_kaohergw){
			this.atzjidukh_kaohergw = atzjidukh_kaohergw;
		}
			 	public String getAtzjidukh_kaohergw(){
	  		return atzjidukh_kaohergw;
	  	}
	    		 		public void setAtzjidukh_kaohekssj(Date atzjidukh_kaohekssj){
			this.atzjidukh_kaohekssj = atzjidukh_kaohekssj;
		}
			 	public Date getAtzjidukh_kaohekssj(){
	  		return atzjidukh_kaohekssj;
	  	}
	    		 		public void setAtzjidukh_kaohejssj(Date atzjidukh_kaohejssj){
			this.atzjidukh_kaohejssj = atzjidukh_kaohejssj;
		}
			 	public Date getAtzjidukh_kaohejssj(){
	  		return atzjidukh_kaohejssj;
	  	}
	    		 		public void setAtzjidukh_renwuwczpdf(Double atzjidukh_renwuwczpdf){
			this.atzjidukh_renwuwczpdf = atzjidukh_renwuwczpdf;
		}
			 	public Double getAtzjidukh_renwuwczpdf(){
	  		return atzjidukh_renwuwczpdf;
	  	}
	    		 		public void setAtzjidukh_renwuwczgpf(Double atzjidukh_renwuwczgpf){
			this.atzjidukh_renwuwczgpf = atzjidukh_renwuwczgpf;
		}
			 	public Double getAtzjidukh_renwuwczgpf(){
	  		return atzjidukh_renwuwczgpf;
	  	}
	    		 		public void setAtzjidukh_jiduzpdf(Double atzjidukh_jiduzpdf){
			this.atzjidukh_jiduzpdf = atzjidukh_jiduzpdf;
		}
			 	public Double getAtzjidukh_jiduzpdf(){
	  		return atzjidukh_jiduzpdf;
	  	}
	    		 		public void setAtzjidukh_zongpingdf(Double atzjidukh_zongpingdf){
			this.atzjidukh_zongpingdf = atzjidukh_zongpingdf;
		}
			 	public Double getAtzjidukh_zongpingdf(){
	  		return atzjidukh_zongpingdf;
	  	}
	    		 		public void setAtzjidukh_beizhu(String atzjidukh_beizhu){
			this.atzjidukh_beizhu = atzjidukh_beizhu;
		}
			 	public String getAtzjidukh_beizhu(){
	  		return atzjidukh_beizhu;
	  	}
	    		 		public void setAtzjidukh_kaohrxm(Long atzjidukh_kaohrxm){
			this.atzjidukh_kaohrxm = atzjidukh_kaohrxm;
		}
			 	public Long getAtzjidukh_kaohrxm(){
	  		return atzjidukh_kaohrxm;
	  	}
	    		 		public void setAtzjidukh_zuihouxgr(String atzjidukh_zuihouxgr){
			this.atzjidukh_zuihouxgr = atzjidukh_zuihouxgr;
		}
			 	public String getAtzjidukh_zuihouxgr(){
	  		return atzjidukh_zuihouxgr;
	  	}
	    		 		public void setAtzjidukh_zuihouxgrq(Date atzjidukh_zuihouxgrq){
			this.atzjidukh_zuihouxgrq = atzjidukh_zuihouxgrq;
		}
			 	public Date getAtzjidukh_zuihouxgrq(){
	  		return atzjidukh_zuihouxgrq;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzjidukh_id(){
  	  	return atzjidukh_id;
  	  }
  	  public void setAtzjidukh_id(Long atzjidukh_id){
  	  	this.atzjidukh_id = atzjidukh_id;
  	  }
	  public Long getId(){
	  	return getAtzjidukh_id();
	  }
