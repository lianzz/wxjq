...
* Author      :Actiz
* Build Time  :2017-11-28 16:00:32.54
*/
...
public class F064fc27700000002z implements IAppEntityObject{
	private Long atztoubiao_id;
			 		...
			 		private Long atzdepartment_id;
					 		...
					 		private Long atztoubiao_lrrid;
					 		private Timestamp atztoubiao_lrsj;
					 		private Timestamp atztoubiao_zhxgsj;
					 		private String atztoubiao_zxry = "";
					 		private String atztoubiao_jsry = "";
					 		private String atztoubiao_bjry = "";
					 		private String atztoubiao_gcry = "";
					 		private String atztoubiao_cgry = "";
					 		private String atztoubiao_qtry = "";
					 		private String atztoubiao_zxygids = "";
					 		private String atztoubiao_jsygids = "";
					 		private String atztoubiao_bjygids = "";
					 		private String atztoubiao_gcygids = "";
					 		private String atztoubiao_cgygids = "";
			...
			this.atztoubiao_actizversion = atztoubiao_actizversion;
			 	...
			 	public Long getAtztoubiao_actizversion(){
	  		return atztoubiao_actizversion;
	  	}
	    		   		 		public void setAtztoubiao_bianhao(String atztoubiao_bianhao){
			this.atztoubiao_bianhao = atztoubiao_bianhao;
		}
			 	public String getAtztoubiao_bianhao(){
	  		return atztoubiao_bianhao;
	  	}
	    		 		public void setAtztoubiao_xsjlid(Long atztoubiao_xsjlid){
			this.atztoubiao_xsjlid = atztoubiao_xsjlid;
		}
			 	public Long getAtztoubiao_xsjlid(){
	  		return atztoubiao_xsjlid;
	  	}
	    		 		public void setAtztoubiao_xsjlxm(String atztoubiao_xsjlxm){
			this.atztoubiao_xsjlxm = atztoubiao_xsjlxm;
		}
			 	public String getAtztoubiao_xsjlxm(){
	  		return atztoubiao_xsjlxm;
	  	}
	    		 		public void setAtztoubiao_daquid(Long atztoubiao_daquid){
			this.atztoubiao_daquid = atztoubiao_daquid;
		}
			 	public Long getAtztoubiao_daquid(){
	  		return atztoubiao_daquid;
	  	}
	    		 		public void setAtztoubiao_daqumc(String atztoubiao_daqumc){
			this.atztoubiao_daqumc = atztoubiao_daqumc;
		}
			...
			this.atztoubiao_xiangmuid = atztoubiao_xiangmuid;
			 	...
			 	public Long getAtztoubiao_xiangmuid(){
	  		return atztoubiao_xiangmuid;
	  	}
	    		 		public void setAtztoubiao_xmbh(String atztoubiao_xmbh){
			this.atztoubiao_xmbh = atztoubiao_xmbh;
		}
			...
			this.atztoubiao_tblx = atztoubiao_tblx;
			 	...
			 	public String getAtztoubiao_tblx(){
	  		return atztoubiao_tblx;
	  	}
	    		 		public void setAtztoubiao_cplx(String atztoubiao_cplx){
			...
			this.atztoubiao_ysje = atztoubiao_ysje;
			 	...
			 	public Double getAtztoubiao_ysje(){
	  		return atztoubiao_ysje;
	  	}
	    		 		public void setAtztoubiao_tbrq(Date atztoubiao_tbrq){
			this.atztoubiao_tbrq = atztoubiao_tbrq;
		}
			 	public Date getAtztoubiao_tbrq(){
	  		return atztoubiao_tbrq;
	  	}
	    		 		public void setAtztoubiao_kbrq(Date atztoubiao_kbrq){
			this.atztoubiao_kbrq = atztoubiao_kbrq;
		}
			 	public Date getAtztoubiao_kbrq(){
	  		return atztoubiao_kbrq;
	  	}
	    		 		public void setAtztoubiao_tbzt(String atztoubiao_tbzt){
			this.atztoubiao_tbzt = atztoubiao_tbzt;
		}
			 	public String getAtztoubiao_tbzt(){
	  		return atztoubiao_tbzt;
	  	}
	    		 		public void setAtztoubiao_fkyj(String atztoubiao_fkyj){
			this.atztoubiao_fkyj = atztoubiao_fkyj;
		}
			 	public String getAtztoubiao_fkyj(){
	  		return atztoubiao_fkyj;
	  	}
	    		 		public void setAtztoubiao_fujian(String atztoubiao_fujian){
			this.atztoubiao_fujian = atztoubiao_fujian;
		}
			...
			this.atztoubiao_beizhu = atztoubiao_beizhu;
			 	...
			 	public String getAtztoubiao_beizhu(){
	  		return atztoubiao_beizhu;
	  	}
	    		 		public void setAtztoubiao_tbdjzt(String atztoubiao_tbdjzt){
			this.atztoubiao_tbdjzt = atztoubiao_tbdjzt;
		}
			 	public String getAtztoubiao_tbdjzt(){
	  		return atztoubiao_tbdjzt;
	  	}
	    		 		public void setAtztoubiao_zuidashhj(Integer atztoubiao_zuidashhj){
			this.atztoubiao_zuidashhj = atztoubiao_zuidashhj;
		}
			 	public Integer getAtztoubiao_zuidashhj(){
	  		return atztoubiao_zuidashhj;
	  	}
	    		 		public void setAtztoubiao_qxyy(String atztoubiao_qxyy){
			this.atztoubiao_qxyy = atztoubiao_qxyy;
		}
			 	public String getAtztoubiao_qxyy(){
	  		return atztoubiao_qxyy;
	  	}
	    		 		public void setAtztoubiao_qxjtyy(String atztoubiao_qxjtyy){
			this.atztoubiao_qxjtyy = atztoubiao_qxjtyy;
		}
			 	public String getAtztoubiao_qxjtyy(){
	  		return atztoubiao_qxjtyy;
	  	}
	    		 		public void setAtztoubiao_lrrid(Long atztoubiao_lrrid){
			this.atztoubiao_lrrid = atztoubiao_lrrid;
		}
			 	public Long getAtztoubiao_lrrid(){
	  		return atztoubiao_lrrid;
	  	}
	    		 		public void setAtztoubiao_lrsj(Timestamp atztoubiao_lrsj){
			this.atztoubiao_lrsj = atztoubiao_lrsj;
		}
			 	public Timestamp getAtztoubiao_lrsj(){
	  		return atztoubiao_lrsj;
	  	}
	    		 		public void setAtztoubiao_zhxgsj(Timestamp atztoubiao_zhxgsj){
			this.atztoubiao_zhxgsj = atztoubiao_zhxgsj;
		}
			 	public Timestamp getAtztoubiao_zhxgsj(){
	  		return atztoubiao_zhxgsj;
	  	}
	    		 		public void setAtztoubiao_zxry(String atztoubiao_zxry){
			this.atztoubiao_zxry = atztoubiao_zxry;
		}
			 	public String getAtztoubiao_zxry(){
	  		return atztoubiao_zxry;
	  	}
	    		 		public void setAtztoubiao_jsry(String atztoubiao_jsry){
			this.atztoubiao_jsry = atztoubiao_jsry;
		}
			 	public String getAtztoubiao_jsry(){
	  		return atztoubiao_jsry;
	  	}
	    		 		public void setAtztoubiao_bjry(String atztoubiao_bjry){
			this.atztoubiao_bjry = atztoubiao_bjry;
		}
			 	public String getAtztoubiao_bjry(){
	  		return atztoubiao_bjry;
	  	}
	    		 		public void setAtztoubiao_gcry(String atztoubiao_gcry){
			this.atztoubiao_gcry = atztoubiao_gcry;
		}
			 	public String getAtztoubiao_gcry(){
	  		return atztoubiao_gcry;
	  	}
	    		 		public void setAtztoubiao_cgry(String atztoubiao_cgry){
			this.atztoubiao_cgry = atztoubiao_cgry;
		}
			 	public String getAtztoubiao_cgry(){
	  		return atztoubiao_cgry;
	  	}
	    		 		public void setAtztoubiao_qtry(String atztoubiao_qtry){
			this.atztoubiao_qtry = atztoubiao_qtry;
		}
			 	public String getAtztoubiao_qtry(){
	  		return atztoubiao_qtry;
	  	}
	    		 		public void setAtztoubiao_zxygids(String atztoubiao_zxygids){
			this.atztoubiao_zxygids = atztoubiao_zxygids;
		}
			 	public String getAtztoubiao_zxygids(){
	  		return atztoubiao_zxygids;
	  	}
	    		 		public void setAtztoubiao_jsygids(String atztoubiao_jsygids){
			this.atztoubiao_jsygids = atztoubiao_jsygids;
		}
			 	public String getAtztoubiao_jsygids(){
	  		return atztoubiao_jsygids;
	  	}
	    		 		public void setAtztoubiao_bjygids(String atztoubiao_bjygids){
			this.atztoubiao_bjygids = atztoubiao_bjygids;
		}
			 	public String getAtztoubiao_bjygids(){
	  		return atztoubiao_bjygids;
	  	}
	    		 		public void setAtztoubiao_gcygids(String atztoubiao_gcygids){
			this.atztoubiao_gcygids = atztoubiao_gcygids;
		}
			 	public String getAtztoubiao_gcygids(){
	  		return atztoubiao_gcygids;
	  	}
	    		 		public void setAtztoubiao_cgygids(String atztoubiao_cgygids){
			this.atztoubiao_cgygids = atztoubiao_cgygids;
		}
			 	public String getAtztoubiao_cgygids(){
	  		return atztoubiao_cgygids;
	  	}
	    		 		public void setAtztoubiao_qtygids(String atztoubiao_qtygids){
			this.atztoubiao_qtygids = atztoubiao_qtygids;
		}
			 	public String getAtztoubiao_qtygids(){
	  		return atztoubiao_qtygids;
	  	}
	    		 		public void setAtztoubiao_qxqzt(String atztoubiao_qxqzt){
			this.atztoubiao_qxqzt = atztoubiao_qxqzt;
		}
			 	public String getAtztoubiao_qxqzt(){
	  		return atztoubiao_qxqzt;
	  	}
	    		 		public void setAtztoubiao_lcyshrids(String atztoubiao_lcyshrids){
			this.atztoubiao_lcyshrids = atztoubiao_lcyshrids;
		}
  	  ...
  	  public void setAtztoubiao_id(Long atztoubiao_id){
  	  	this.atztoubiao_id = atztoubiao_id;
  	  }
	  public Long getId(){
	  	return getAtztoubiao_id();
	  }
