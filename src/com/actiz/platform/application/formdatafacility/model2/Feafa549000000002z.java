...
* Author      :Actiz
* Build Time  :2017-11-28 15:59:26.248
*/
...
public class Feafa549000000002z implements IAppEntityObject{
	private Long atzweibaotk_id;
			 		...
			 		private Long atzkehu_id;
					 		...
					 		private Long atzweibaotk_actizversion;
					 			 		private Long atzweibaotk_hetongid;
					 		private Date atzweibaotk_kaishisj;
					 		private String atzweibaotk_weibaokscftj = "";
					 		private Integer atzweibaotk_mnfwzjjlcs = 0;
					 		private Double atzweibaotk_jjgzjwxfwsx = 48.0;
					 		private Double atzweibaotk_ybgzjwxfwsx = 15.0;
					 		private Integer atzweibaotk_mnxcxjcs = 0;
					 		private Integer atzweibaotk_mnycxjcs = 0;
					 		private Integer atzweibaotk_meinianxjcs = 0;
					 		private String atzweibaotk_qiesfw = "";
					 		private String atzweibaotk_wujiufw = "";
					 		private String atzweibaotk_shebeiyjwx = "";
					 		private String atzweibaotk_shebeiyjgh = "";
					 		private String atzweibaotk_xczcfw = "";
					 		private String atzweibaotk_jishuzxfw = "";
					 		private String atzweibaotk_ycgzclfw = "";
					 		private String atzweibaotk_xcgzclfw = "";
					 		private String atzweibaotk_rjsjjbdfw = "";
					 		private String atzweibaotk_kehupxfw = "";
					 		private Integer atzweibaotk_kehupxrs = 0;
					 		private String atzweibaotk_beizhu;
					 		private String atzweibaotk_weibaodw = "";
					 		private Integer atzweibaotk_weibaoqx = 0;
					 		private Date atzweibaotk_lururq;
					 		private Date atzweibaotk_cbsj;
					 		private Date atzweibaotk_xbsj;
					 		private String atzweibaotk_gcysbz = "";
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    		 		...
	    		 		public void setAtzweibaotk_actizversion(Long atzweibaotk_actizversion){
			this.atzweibaotk_actizversion = atzweibaotk_actizversion;
		}
			 	public Long getAtzweibaotk_actizversion(){
	  		return atzweibaotk_actizversion;
	  	}
	    		   		 		public void setAtzweibaotk_hetongid(Long atzweibaotk_hetongid){
			this.atzweibaotk_hetongid = atzweibaotk_hetongid;
		}
			 	public Long getAtzweibaotk_hetongid(){
	  		return atzweibaotk_hetongid;
	  	}
	    		 		public void setAtzweibaotk_kaishisj(Date atzweibaotk_kaishisj){
			this.atzweibaotk_kaishisj = atzweibaotk_kaishisj;
		}
			 	public Date getAtzweibaotk_kaishisj(){
	  		return atzweibaotk_kaishisj;
	  	}
	    		 		public void setAtzweibaotk_weibaokscftj(String atzweibaotk_weibaokscftj){
			this.atzweibaotk_weibaokscftj = atzweibaotk_weibaokscftj;
		}
			 	public String getAtzweibaotk_weibaokscftj(){
	  		return atzweibaotk_weibaokscftj;
	  	}
	    		 		public void setAtzweibaotk_mnfwzjjlcs(Integer atzweibaotk_mnfwzjjlcs){
			this.atzweibaotk_mnfwzjjlcs = atzweibaotk_mnfwzjjlcs;
		}
			 	public Integer getAtzweibaotk_mnfwzjjlcs(){
	  		return atzweibaotk_mnfwzjjlcs;
	  	}
	    		 		public void setAtzweibaotk_jjgzjwxfwsx(Double atzweibaotk_jjgzjwxfwsx){
			this.atzweibaotk_jjgzjwxfwsx = atzweibaotk_jjgzjwxfwsx;
		}
			 	public Double getAtzweibaotk_jjgzjwxfwsx(){
	  		return atzweibaotk_jjgzjwxfwsx;
	  	}
	    		 		public void setAtzweibaotk_ybgzjwxfwsx(Double atzweibaotk_ybgzjwxfwsx){
			this.atzweibaotk_ybgzjwxfwsx = atzweibaotk_ybgzjwxfwsx;
		}
			 	public Double getAtzweibaotk_ybgzjwxfwsx(){
	  		return atzweibaotk_ybgzjwxfwsx;
	  	}
	    		 		public void setAtzweibaotk_mnxcxjcs(Integer atzweibaotk_mnxcxjcs){
			this.atzweibaotk_mnxcxjcs = atzweibaotk_mnxcxjcs;
		}
			 	public Integer getAtzweibaotk_mnxcxjcs(){
	  		return atzweibaotk_mnxcxjcs;
	  	}
	    		 		public void setAtzweibaotk_mnycxjcs(Integer atzweibaotk_mnycxjcs){
			this.atzweibaotk_mnycxjcs = atzweibaotk_mnycxjcs;
		}
			 	public Integer getAtzweibaotk_mnycxjcs(){
	  		return atzweibaotk_mnycxjcs;
	  	}
	    		 		public void setAtzweibaotk_meinianxjcs(Integer atzweibaotk_meinianxjcs){
			this.atzweibaotk_meinianxjcs = atzweibaotk_meinianxjcs;
		}
			 	public Integer getAtzweibaotk_meinianxjcs(){
	  		return atzweibaotk_meinianxjcs;
	  	}
	    		 		public void setAtzweibaotk_qiesfw(String atzweibaotk_qiesfw){
			this.atzweibaotk_qiesfw = atzweibaotk_qiesfw;
		}
			 	public String getAtzweibaotk_qiesfw(){
	  		return atzweibaotk_qiesfw;
	  	}
	    		 		public void setAtzweibaotk_wujiufw(String atzweibaotk_wujiufw){
			this.atzweibaotk_wujiufw = atzweibaotk_wujiufw;
		}
			 	public String getAtzweibaotk_wujiufw(){
	  		return atzweibaotk_wujiufw;
	  	}
	    		 		public void setAtzweibaotk_shebeiyjwx(String atzweibaotk_shebeiyjwx){
			this.atzweibaotk_shebeiyjwx = atzweibaotk_shebeiyjwx;
		}
			 	public String getAtzweibaotk_shebeiyjwx(){
	  		return atzweibaotk_shebeiyjwx;
	  	}
	    		 		public void setAtzweibaotk_shebeiyjgh(String atzweibaotk_shebeiyjgh){
			this.atzweibaotk_shebeiyjgh = atzweibaotk_shebeiyjgh;
		}
			 	public String getAtzweibaotk_shebeiyjgh(){
	  		return atzweibaotk_shebeiyjgh;
	  	}
	    		 		public void setAtzweibaotk_xczcfw(String atzweibaotk_xczcfw){
			this.atzweibaotk_xczcfw = atzweibaotk_xczcfw;
		}
			 	public String getAtzweibaotk_xczcfw(){
	  		return atzweibaotk_xczcfw;
	  	}
	    		 		public void setAtzweibaotk_jishuzxfw(String atzweibaotk_jishuzxfw){
			this.atzweibaotk_jishuzxfw = atzweibaotk_jishuzxfw;
		}
			 	public String getAtzweibaotk_jishuzxfw(){
	  		return atzweibaotk_jishuzxfw;
	  	}
	    		 		public void setAtzweibaotk_ycgzclfw(String atzweibaotk_ycgzclfw){
			this.atzweibaotk_ycgzclfw = atzweibaotk_ycgzclfw;
		}
			 	public String getAtzweibaotk_ycgzclfw(){
	  		return atzweibaotk_ycgzclfw;
	  	}
	    		 		public void setAtzweibaotk_xcgzclfw(String atzweibaotk_xcgzclfw){
			this.atzweibaotk_xcgzclfw = atzweibaotk_xcgzclfw;
		}
			 	public String getAtzweibaotk_xcgzclfw(){
	  		return atzweibaotk_xcgzclfw;
	  	}
	    		 		public void setAtzweibaotk_rjsjjbdfw(String atzweibaotk_rjsjjbdfw){
			this.atzweibaotk_rjsjjbdfw = atzweibaotk_rjsjjbdfw;
		}
			 	public String getAtzweibaotk_rjsjjbdfw(){
	  		return atzweibaotk_rjsjjbdfw;
	  	}
	    		 		public void setAtzweibaotk_kehupxfw(String atzweibaotk_kehupxfw){
			this.atzweibaotk_kehupxfw = atzweibaotk_kehupxfw;
		}
			 	public String getAtzweibaotk_kehupxfw(){
	  		return atzweibaotk_kehupxfw;
	  	}
	    		 		public void setAtzweibaotk_kehupxrs(Integer atzweibaotk_kehupxrs){
			this.atzweibaotk_kehupxrs = atzweibaotk_kehupxrs;
		}
			 	public Integer getAtzweibaotk_kehupxrs(){
	  		return atzweibaotk_kehupxrs;
	  	}
	    		 		public void setAtzweibaotk_beizhu(String atzweibaotk_beizhu){
			this.atzweibaotk_beizhu = atzweibaotk_beizhu;
		}
			 	public String getAtzweibaotk_beizhu(){
	  		return atzweibaotk_beizhu;
	  	}
	    		 		public void setAtzweibaotk_weibaodw(String atzweibaotk_weibaodw){
			this.atzweibaotk_weibaodw = atzweibaotk_weibaodw;
		}
			 	public String getAtzweibaotk_weibaodw(){
	  		return atzweibaotk_weibaodw;
	  	}
	    		 		public void setAtzweibaotk_weibaoqx(Integer atzweibaotk_weibaoqx){
			this.atzweibaotk_weibaoqx = atzweibaotk_weibaoqx;
		}
			 	public Integer getAtzweibaotk_weibaoqx(){
	  		return atzweibaotk_weibaoqx;
	  	}
	    		 		public void setAtzweibaotk_lururq(Date atzweibaotk_lururq){
			this.atzweibaotk_lururq = atzweibaotk_lururq;
		}
			 	public Date getAtzweibaotk_lururq(){
	  		return atzweibaotk_lururq;
	  	}
	    		 		public void setAtzweibaotk_cbsj(Date atzweibaotk_cbsj){
			this.atzweibaotk_cbsj = atzweibaotk_cbsj;
		}
			 	public Date getAtzweibaotk_cbsj(){
	  		return atzweibaotk_cbsj;
	  	}
	    		 		public void setAtzweibaotk_xbsj(Date atzweibaotk_xbsj){
			this.atzweibaotk_xbsj = atzweibaotk_xbsj;
		}
			 	public Date getAtzweibaotk_xbsj(){
	  		return atzweibaotk_xbsj;
	  	}
	    		 		public void setAtzweibaotk_gcysbz(String atzweibaotk_gcysbz){
			this.atzweibaotk_gcysbz = atzweibaotk_gcysbz;
		}
			 	public String getAtzweibaotk_gcysbz(){
	  		return atzweibaotk_gcysbz;
	  	}
	    	  	  public Long getAtzweibaotk_id(){
  	  	return atzweibaotk_id;
  	  }
  	  public void setAtzweibaotk_id(Long atzweibaotk_id){
  	  	this.atzweibaotk_id = atzweibaotk_id;
  	  }
	  public Long getId(){
	  	return getAtzweibaotk_id();
	  }
