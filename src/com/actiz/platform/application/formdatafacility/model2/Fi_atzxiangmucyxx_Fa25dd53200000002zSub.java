...
* Author      :Actiz
* Build Time  :2017-12-11 15:30:31.126
*/
...
import java.sql.Blob;
	...
	public class Fi_atzxiangmucyxx_Fa25dd53200000002zSub{

			private Long atzemployee_id;
			private Long atzxiangmucyxx_id;
			private Long atzxiangmucyxx_yuangongmc;
			...
			private Long atzxiangmucyxx_xiangmuid;
  		...
  		public Long getAtzemployee_id(){
  			...
  			public void setAtzxiangmucyxx_id(Long atzxiangmucyxx_id){
			this.atzxiangmucyxx_id = atzxiangmucyxx_id;
		}
		
  		public Long getAtzxiangmucyxx_id(){
  			return atzxiangmucyxx_id;
  		}
  			public void setAtzxiangmucyxx_yuangongmc(Long atzxiangmucyxx_yuangongmc){
			this.atzxiangmucyxx_yuangongmc = atzxiangmucyxx_yuangongmc;
		}
		
  		public Long getAtzxiangmucyxx_yuangongmc(){
  			return atzxiangmucyxx_yuangongmc;
  		}
  		...
  		public String getAtzemployee_sex(){
  			...
  			public void setAtzxiangmucyxx_xiangmuid(Long atzxiangmucyxx_xiangmuid){
			this.atzxiangmucyxx_xiangmuid = atzxiangmucyxx_xiangmuid;
		}
		
  		public Long getAtzxiangmucyxx_xiangmuid(){
  			return atzxiangmucyxx_xiangmuid;
  		}
