...
* Author      :Actiz
* Build Time  :2017-11-28 15:57:56.273
*/
...
public class Fee92830700000014z implements IAppEntityObject{
	private Long atzzichanwx_id;
	
			 		private Long atzzichanwx_actizversion;
					 			 		private Long atzzichanwx_zichan;
					 		private Long atzzichanwx_shenqingr;
					 		private Date atzzichanwx_shenqingrq;
					 		private Double atzzichanwx_wxje = 0.0;
					 		private String atzzichanwx_shenqingyy;
					 		private String atzzichanwx_peizhigg;
					 		private String atzzichanwx_lurur = "";
					 		private Date atzzichanwx_lururq;
					 		private String atzzichanwx_zuihouxgr = "";
					 		private Date atzzichanwx_zuihouxgrq;
					 		private String atzzichanwx_danjuzt = "";
					 		private Long atzzichanwx_lururid;
					 		private Long atzzichanwx_zuihouxgrid;
					 		private String atzzichanwx_zcsfwh = "";
					 		private String atzzichanwx_weixiujg;
					 		...
					 		public void setAtzzichanwx_actizversion(Long atzzichanwx_actizversion){
			this.atzzichanwx_actizversion = atzzichanwx_actizversion;
		}
			 	public Long getAtzzichanwx_actizversion(){
	  		return atzzichanwx_actizversion;
	  	}
	    		   		 		public void setAtzzichanwx_zichan(Long atzzichanwx_zichan){
			this.atzzichanwx_zichan = atzzichanwx_zichan;
		}
			 	public Long getAtzzichanwx_zichan(){
	  		return atzzichanwx_zichan;
	  	}
	    		 		public void setAtzzichanwx_shenqingr(Long atzzichanwx_shenqingr){
			this.atzzichanwx_shenqingr = atzzichanwx_shenqingr;
		}
			 	public Long getAtzzichanwx_shenqingr(){
	  		return atzzichanwx_shenqingr;
	  	}
	    		 		public void setAtzzichanwx_shenqingrq(Date atzzichanwx_shenqingrq){
			this.atzzichanwx_shenqingrq = atzzichanwx_shenqingrq;
		}
			 	public Date getAtzzichanwx_shenqingrq(){
	  		return atzzichanwx_shenqingrq;
	  	}
	    		 		public void setAtzzichanwx_wxje(Double atzzichanwx_wxje){
			this.atzzichanwx_wxje = atzzichanwx_wxje;
		}
			 	public Double getAtzzichanwx_wxje(){
	  		return atzzichanwx_wxje;
	  	}
	    		 		public void setAtzzichanwx_shenqingyy(String atzzichanwx_shenqingyy){
			this.atzzichanwx_shenqingyy = atzzichanwx_shenqingyy;
		}
			 	public String getAtzzichanwx_shenqingyy(){
	  		return atzzichanwx_shenqingyy;
	  	}
	    		 		public void setAtzzichanwx_peizhigg(String atzzichanwx_peizhigg){
			this.atzzichanwx_peizhigg = atzzichanwx_peizhigg;
		}
			 	public String getAtzzichanwx_peizhigg(){
	  		return atzzichanwx_peizhigg;
	  	}
	    		 		public void setAtzzichanwx_lurur(String atzzichanwx_lurur){
			this.atzzichanwx_lurur = atzzichanwx_lurur;
		}
			 	public String getAtzzichanwx_lurur(){
	  		return atzzichanwx_lurur;
	  	}
	    		 		public void setAtzzichanwx_lururq(Date atzzichanwx_lururq){
			this.atzzichanwx_lururq = atzzichanwx_lururq;
		}
			 	public Date getAtzzichanwx_lururq(){
	  		return atzzichanwx_lururq;
	  	}
	    		 		public void setAtzzichanwx_zuihouxgr(String atzzichanwx_zuihouxgr){
			this.atzzichanwx_zuihouxgr = atzzichanwx_zuihouxgr;
		}
			 	public String getAtzzichanwx_zuihouxgr(){
	  		return atzzichanwx_zuihouxgr;
	  	}
	    		 		public void setAtzzichanwx_zuihouxgrq(Date atzzichanwx_zuihouxgrq){
			this.atzzichanwx_zuihouxgrq = atzzichanwx_zuihouxgrq;
		}
			 	public Date getAtzzichanwx_zuihouxgrq(){
	  		return atzzichanwx_zuihouxgrq;
	  	}
	    		 		public void setAtzzichanwx_danjuzt(String atzzichanwx_danjuzt){
			this.atzzichanwx_danjuzt = atzzichanwx_danjuzt;
		}
			 	public String getAtzzichanwx_danjuzt(){
	  		return atzzichanwx_danjuzt;
	  	}
	    		 		public void setAtzzichanwx_lururid(Long atzzichanwx_lururid){
			this.atzzichanwx_lururid = atzzichanwx_lururid;
		}
			 	public Long getAtzzichanwx_lururid(){
	  		return atzzichanwx_lururid;
	  	}
	    		 		public void setAtzzichanwx_zuihouxgrid(Long atzzichanwx_zuihouxgrid){
			this.atzzichanwx_zuihouxgrid = atzzichanwx_zuihouxgrid;
		}
			 	public Long getAtzzichanwx_zuihouxgrid(){
	  		return atzzichanwx_zuihouxgrid;
	  	}
	    		 		public void setAtzzichanwx_zcsfwh(String atzzichanwx_zcsfwh){
			this.atzzichanwx_zcsfwh = atzzichanwx_zcsfwh;
		}
			 	public String getAtzzichanwx_zcsfwh(){
	  		return atzzichanwx_zcsfwh;
	  	}
	    		 		public void setAtzzichanwx_weixiujg(String atzzichanwx_weixiujg){
			this.atzzichanwx_weixiujg = atzzichanwx_weixiujg;
		}
			 	public String getAtzzichanwx_weixiujg(){
	  		return atzzichanwx_weixiujg;
	  	}
			...
			this.atzgudingzc_shifousc = atzgudingzc_shifousc;
	  		...
	  		return atzgudingzc_shifousc;
	    	  	  ...
	    	  	  public Long getAtzzichanwx_id(){
  	  	return atzzichanwx_id;
  	  }
  	  public void setAtzzichanwx_id(Long atzzichanwx_id){
  	  	this.atzzichanwx_id = atzzichanwx_id;
  	  }
	  public Long getId(){
	  	return getAtzzichanwx_id();
	  }
