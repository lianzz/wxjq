...
* Author      :Actiz
* Build Time  :2017-11-28 16:08:39.869
*/
...
import java.sql.Blob;
	public class F4f22540c00000001z implements IAppEntityObject{
	private Long atzfahuotzd_id;
			 		...
			 		private Long atzkehu_id;
					 		...
					 		private Long fhd_id;
					 		private String fhd_bianhao = "";
					 		private String fhd_linshibh = "";
					 		private String fhd_zhuti = "";
					 		private String fhd_bianhaoqz = "";
					 		private Long fhd_hetongid;
					 		private Long fhd_kehuid;
					 		private String fhd_kehujl = "";
					 		private String fhd_lianxidh = "";
					 		private String fhd_banbenxx = "";
					 		private String fhd_xitongpz = "";
					 		private Double fhd_huowubj = 0.0;
					 		private Date fhd_daohuorq;
					 		private String fhd_daohuodd = "";
					 		private String fhd_shouhuolxr = "";
					 		private String fhd_shouhuolxdh = "";
					 		private String fhd_jutigznrbc;
					 		private String fhd_danjuzt = "1";
					 		private String fhd_zhidanr = "";
					 		private Date fhd_zhidanrq;
					 		private String fhd_zuihouxgr = "";
					 		private Date fhd_zuihouxgrq;
					 		private String fhd_shenhezt = "";
					 		private String fhd_shenheyj;
					 		private String fhd_shifoujy = "";
					 		private String fhd_shifouwc = "";
					 		private String fhd_fahuotzdlx = "";
					 		private Date fhd_fahuorq;
					 		private String fhd_xiaoshoujl = "";
					 		private String fhd_xsjllxfs = "";
					 		private String fhd_gcxmjl = "";
					 		private String fhd_gcxmjllxfs = "";
					 		private Long fhd_fahuotzdid;
					 		private String fhd_shenqingyy = "";
					 		private String fhd_beizhu;
					 		private Date fhd_yjfhsj;
					 		private String fhd_fahuolxlx = "";
					 		private Long fhd_xiaoshoujlid;
					 		private Long fhd_xmpzqdid;
					 		...
					 		private Long atzfahuotzd_actizversion;
			...
			this.atzkehu_xiaoshoujl = atzkehu_xiaoshoujl;
	  		...
	  		return atzkehu_xiaoshoujl;
	    		 		...
	    		 		public void setFhd_id(Long fhd_id){
			this.fhd_id = fhd_id;
		}
			 	public Long getFhd_id(){
	  		return fhd_id;
	  	}
	    		 		public void setFhd_bianhao(String fhd_bianhao){
			this.fhd_bianhao = fhd_bianhao;
		}
			 	public String getFhd_bianhao(){
	  		return fhd_bianhao;
	  	}
	    		 		public void setFhd_linshibh(String fhd_linshibh){
			this.fhd_linshibh = fhd_linshibh;
		}
			 	public String getFhd_linshibh(){
	  		return fhd_linshibh;
	  	}
	    		 		public void setFhd_zhuti(String fhd_zhuti){
			this.fhd_zhuti = fhd_zhuti;
		}
			 	public String getFhd_zhuti(){
	  		return fhd_zhuti;
	  	}
	    		 		public void setFhd_bianhaoqz(String fhd_bianhaoqz){
			this.fhd_bianhaoqz = fhd_bianhaoqz;
		}
			 	public String getFhd_bianhaoqz(){
	  		return fhd_bianhaoqz;
	  	}
	    		 		public void setFhd_hetongid(Long fhd_hetongid){
			this.fhd_hetongid = fhd_hetongid;
		}
			 	public Long getFhd_hetongid(){
	  		return fhd_hetongid;
	  	}
	    		 		public void setFhd_kehuid(Long fhd_kehuid){
			this.fhd_kehuid = fhd_kehuid;
		}
			 	public Long getFhd_kehuid(){
	  		return fhd_kehuid;
	  	}
	    		 		public void setFhd_kehujl(String fhd_kehujl){
			this.fhd_kehujl = fhd_kehujl;
		}
			 	public String getFhd_kehujl(){
	  		return fhd_kehujl;
	  	}
	    		 		public void setFhd_lianxidh(String fhd_lianxidh){
			this.fhd_lianxidh = fhd_lianxidh;
		}
			 	public String getFhd_lianxidh(){
	  		return fhd_lianxidh;
	  	}
	    		 		public void setFhd_banbenxx(String fhd_banbenxx){
			this.fhd_banbenxx = fhd_banbenxx;
		}
			 	public String getFhd_banbenxx(){
	  		return fhd_banbenxx;
	  	}
	    		 		public void setFhd_xitongpz(String fhd_xitongpz){
			this.fhd_xitongpz = fhd_xitongpz;
		}
			 	public String getFhd_xitongpz(){
	  		return fhd_xitongpz;
	  	}
	    		 		public void setFhd_huowubj(Double fhd_huowubj){
			this.fhd_huowubj = fhd_huowubj;
		}
			 	public Double getFhd_huowubj(){
	  		return fhd_huowubj;
	  	}
	    		 		public void setFhd_daohuorq(Date fhd_daohuorq){
			this.fhd_daohuorq = fhd_daohuorq;
		}
			 	public Date getFhd_daohuorq(){
	  		return fhd_daohuorq;
	  	}
	    		 		public void setFhd_daohuodd(String fhd_daohuodd){
			this.fhd_daohuodd = fhd_daohuodd;
		}
			 	public String getFhd_daohuodd(){
	  		return fhd_daohuodd;
	  	}
	    		 		public void setFhd_shouhuolxr(String fhd_shouhuolxr){
			this.fhd_shouhuolxr = fhd_shouhuolxr;
		}
			 	public String getFhd_shouhuolxr(){
	  		return fhd_shouhuolxr;
	  	}
	    		 		public void setFhd_shouhuolxdh(String fhd_shouhuolxdh){
			this.fhd_shouhuolxdh = fhd_shouhuolxdh;
		}
			 	public String getFhd_shouhuolxdh(){
	  		return fhd_shouhuolxdh;
	  	}
	    		 		public void setFhd_jutigznrbc(String fhd_jutigznrbc){
			this.fhd_jutigznrbc = fhd_jutigznrbc;
		}
			 	public String getFhd_jutigznrbc(){
	  		return fhd_jutigznrbc;
	  	}
	    		 		public void setFhd_danjuzt(String fhd_danjuzt){
			this.fhd_danjuzt = fhd_danjuzt;
		}
			 	public String getFhd_danjuzt(){
	  		return fhd_danjuzt;
	  	}
	    		 		public void setFhd_zhidanr(String fhd_zhidanr){
			this.fhd_zhidanr = fhd_zhidanr;
		}
			 	public String getFhd_zhidanr(){
	  		return fhd_zhidanr;
	  	}
	    		 		public void setFhd_zhidanrq(Date fhd_zhidanrq){
			this.fhd_zhidanrq = fhd_zhidanrq;
		}
			 	public Date getFhd_zhidanrq(){
	  		return fhd_zhidanrq;
	  	}
	    		 		public void setFhd_zuihouxgr(String fhd_zuihouxgr){
			this.fhd_zuihouxgr = fhd_zuihouxgr;
		}
			 	public String getFhd_zuihouxgr(){
	  		return fhd_zuihouxgr;
	  	}
	    		 		public void setFhd_zuihouxgrq(Date fhd_zuihouxgrq){
			this.fhd_zuihouxgrq = fhd_zuihouxgrq;
		}
			 	public Date getFhd_zuihouxgrq(){
	  		return fhd_zuihouxgrq;
	  	}
	    		 		public void setFhd_shenhezt(String fhd_shenhezt){
			this.fhd_shenhezt = fhd_shenhezt;
		}
			 	public String getFhd_shenhezt(){
	  		return fhd_shenhezt;
	  	}
	    		 		public void setFhd_shenheyj(String fhd_shenheyj){
			this.fhd_shenheyj = fhd_shenheyj;
		}
			 	public String getFhd_shenheyj(){
	  		return fhd_shenheyj;
	  	}
	    		 		public void setFhd_shifoujy(String fhd_shifoujy){
			this.fhd_shifoujy = fhd_shifoujy;
		}
			 	public String getFhd_shifoujy(){
	  		return fhd_shifoujy;
	  	}
	    		 		public void setFhd_shifouwc(String fhd_shifouwc){
			this.fhd_shifouwc = fhd_shifouwc;
		}
			 	public String getFhd_shifouwc(){
	  		return fhd_shifouwc;
	  	}
	    		 		public void setFhd_fahuotzdlx(String fhd_fahuotzdlx){
			this.fhd_fahuotzdlx = fhd_fahuotzdlx;
		}
			 	public String getFhd_fahuotzdlx(){
	  		return fhd_fahuotzdlx;
	  	}
	    		 		public void setFhd_fahuorq(Date fhd_fahuorq){
			this.fhd_fahuorq = fhd_fahuorq;
		}
			 	public Date getFhd_fahuorq(){
	  		return fhd_fahuorq;
	  	}
	    		 		public void setFhd_xiaoshoujl(String fhd_xiaoshoujl){
			this.fhd_xiaoshoujl = fhd_xiaoshoujl;
		}
			 	public String getFhd_xiaoshoujl(){
	  		return fhd_xiaoshoujl;
	  	}
	    		 		public void setFhd_xsjllxfs(String fhd_xsjllxfs){
			this.fhd_xsjllxfs = fhd_xsjllxfs;
		}
			 	public String getFhd_xsjllxfs(){
	  		return fhd_xsjllxfs;
	  	}
	    		 		public void setFhd_gcxmjl(String fhd_gcxmjl){
			this.fhd_gcxmjl = fhd_gcxmjl;
		}
			 	public String getFhd_gcxmjl(){
	  		return fhd_gcxmjl;
	  	}
	    		 		public void setFhd_gcxmjllxfs(String fhd_gcxmjllxfs){
			this.fhd_gcxmjllxfs = fhd_gcxmjllxfs;
		}
			 	public String getFhd_gcxmjllxfs(){
	  		return fhd_gcxmjllxfs;
	  	}
	    		 		public void setFhd_fahuotzdid(Long fhd_fahuotzdid){
			this.fhd_fahuotzdid = fhd_fahuotzdid;
		}
			 	public Long getFhd_fahuotzdid(){
	  		return fhd_fahuotzdid;
	  	}
	    		 		public void setFhd_shenqingyy(String fhd_shenqingyy){
			this.fhd_shenqingyy = fhd_shenqingyy;
		}
			 	public String getFhd_shenqingyy(){
	  		return fhd_shenqingyy;
	  	}
	    		 		public void setFhd_beizhu(String fhd_beizhu){
			this.fhd_beizhu = fhd_beizhu;
		}
			 	public String getFhd_beizhu(){
	  		return fhd_beizhu;
	  	}
	    		 		public void setFhd_yjfhsj(Date fhd_yjfhsj){
			this.fhd_yjfhsj = fhd_yjfhsj;
		}
			 	public Date getFhd_yjfhsj(){
	  		return fhd_yjfhsj;
	  	}
	    		 		public void setFhd_fahuolxlx(String fhd_fahuolxlx){
			this.fhd_fahuolxlx = fhd_fahuolxlx;
		}
			 	public String getFhd_fahuolxlx(){
	  		return fhd_fahuolxlx;
	  	}
	    		 		public void setFhd_xiaoshoujlid(Long fhd_xiaoshoujlid){
			this.fhd_xiaoshoujlid = fhd_xiaoshoujlid;
		}
			 	public Long getFhd_xiaoshoujlid(){
	  		return fhd_xiaoshoujlid;
	  	}
	    		 		public void setFhd_xmpzqdid(Long fhd_xmpzqdid){
			this.fhd_xmpzqdid = fhd_xmpzqdid;
		}
			 	public Long getFhd_xmpzqdid(){
	  		return fhd_xmpzqdid;
	  	}
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    		 		...
	    		 		public void setAtzfahuotzd_actizversion(Long atzfahuotzd_actizversion){
			this.atzfahuotzd_actizversion = atzfahuotzd_actizversion;
		}
			 	public Long getAtzfahuotzd_actizversion(){
	  		return atzfahuotzd_actizversion;
	  	}
