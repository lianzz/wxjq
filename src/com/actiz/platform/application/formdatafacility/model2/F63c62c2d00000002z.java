...
* Author      :Actiz
* Build Time  :2017-12-04 14:51:04.589
*/
...
import java.sql.Blob;
	...
	public class F63c62c2d00000002z{

			private Long atzhetong_id;
			private Long atzkehu_id;
			private Long atzkaipiaosqd_id;
			private Long atzkhyinhangzh_id;
			private String atzkaipiaosqd_bianhao = "";
			private String atzhetong_hetongbh = "";
			private Double atzhetong_hetongje = 0.0;
			private Double atzhetong_weikpje = 0.0;
			private String atzkaipiaosqd_piaojulx = "";
			private Double atzkaipiaosqd_shuilv = 0.0;
			private String atzkaipiaosqd_beizhu;
			private String atzkaipiaosqd_zhidanr = "";
			private Date atzkaipiaosqd_zhidanrq;
			private String atzkaipiaosqd_zuihouxgr = "";
			private Date atzkaipiaosqd_zuihouxgrq;
			private String atzkehu_kehumc = "";
			private String atzkhyinhangzh_kaihuyh = "";
			private String atzkhyinhangzh_yinhangzh = "";
			private String atzkhyinhangzh_shuiwudjh = "";
			private String atzkehu_tongxundz = "";
			private String atzkehu_dianhua = "";
			private Double atzkaipiaosqd_hejije = 0.0;
			private Long atzkaipiaosqd_wubizl;
			private Double atzkaipiaosqd_dangshihl = 0.0;
			private Double atzkaipiaosqd_hejiwbje = 0.0;
			private String atzkaipiaosqd_wofangdwmc = "";
			private String atzkaipiaosqd_wofangkhyh = "";
			private String atzkaipiaosqd_wofangyhzh = "";
			private String atzkaipiaosqd_wofangswdjh = "";
			private String atzkaipiaosqd_wofangdz = "";
			private String atzkaipiaosqd_wofangdh = "";
			private Long atzkaipiaosqd_hetongid;
			private String atzkaipiaosqd_linshibh = "";
			private Date atzkaipiaosqd_kaipiaorq;
			private Long atzkaipiaosqd_kehuid;
			private Long atzkaipiaosqd_kehuyhzh;
			private String atzkaipiaosqd_yinghangzh = "";
			private String atzkaipiaosqd_danjuzt = "";
			private String atzkaipiaosqd_zhixingzt = "";
			private String atzkaipiaosqd_shenhezt = "";
			private String atzkaipiaosqd_shenheyj;
			...
			private Long atzkhyinhangzh_kehuid;
			private String atzkhyinhangzh_shifouyx = "";
			private Date atzkhyinhangzh_shixiaorq;
			private Date atzkhyinhangzh_lururq;
			private String atzkhyinhangzh_beizhu;
  		...
  		public Long getAtzkehu_id(){
  			...
  			public void setAtzkaipiaosqd_id(Long atzkaipiaosqd_id){
			this.atzkaipiaosqd_id = atzkaipiaosqd_id;
		}
		
  		public Long getAtzkaipiaosqd_id(){
  			return atzkaipiaosqd_id;
  		}
  			public void setAtzkhyinhangzh_id(Long atzkhyinhangzh_id){
			this.atzkhyinhangzh_id = atzkhyinhangzh_id;
		}
		
  		public Long getAtzkhyinhangzh_id(){
  			return atzkhyinhangzh_id;
  		}
  			public void setAtzkaipiaosqd_bianhao(String atzkaipiaosqd_bianhao){
			this.atzkaipiaosqd_bianhao = atzkaipiaosqd_bianhao;
		}
		
  		public String getAtzkaipiaosqd_bianhao(){
  			return atzkaipiaosqd_bianhao;
  		}
  		...
  		public Double getAtzhetong_weikpje(){
  			...
  			public void setAtzkaipiaosqd_piaojulx(String atzkaipiaosqd_piaojulx){
			this.atzkaipiaosqd_piaojulx = atzkaipiaosqd_piaojulx;
		}
		
  		public String getAtzkaipiaosqd_piaojulx(){
  			return atzkaipiaosqd_piaojulx;
  		}
  			public void setAtzkaipiaosqd_shuilv(Double atzkaipiaosqd_shuilv){
			this.atzkaipiaosqd_shuilv = atzkaipiaosqd_shuilv;
		}
		
  		public Double getAtzkaipiaosqd_shuilv(){
  			return atzkaipiaosqd_shuilv;
  		}
  			public void setAtzkaipiaosqd_beizhu(String atzkaipiaosqd_beizhu){
			this.atzkaipiaosqd_beizhu = atzkaipiaosqd_beizhu;
		}
		
  		public String getAtzkaipiaosqd_beizhu(){
  			return atzkaipiaosqd_beizhu;
  		}
  			public void setAtzkaipiaosqd_zhidanr(String atzkaipiaosqd_zhidanr){
			this.atzkaipiaosqd_zhidanr = atzkaipiaosqd_zhidanr;
		}
		
  		public String getAtzkaipiaosqd_zhidanr(){
  			return atzkaipiaosqd_zhidanr;
  		}
  			public void setAtzkaipiaosqd_zhidanrq(Date atzkaipiaosqd_zhidanrq){
			this.atzkaipiaosqd_zhidanrq = atzkaipiaosqd_zhidanrq;
		}
		
  		public Date getAtzkaipiaosqd_zhidanrq(){
  			return atzkaipiaosqd_zhidanrq;
  		}
  			public void setAtzkaipiaosqd_zuihouxgr(String atzkaipiaosqd_zuihouxgr){
			this.atzkaipiaosqd_zuihouxgr = atzkaipiaosqd_zuihouxgr;
		}
		
  		public String getAtzkaipiaosqd_zuihouxgr(){
  			return atzkaipiaosqd_zuihouxgr;
  		}
  			public void setAtzkaipiaosqd_zuihouxgrq(Date atzkaipiaosqd_zuihouxgrq){
			this.atzkaipiaosqd_zuihouxgrq = atzkaipiaosqd_zuihouxgrq;
		}
		
  		public Date getAtzkaipiaosqd_zuihouxgrq(){
  			return atzkaipiaosqd_zuihouxgrq;
  		}
  		...
  		public String getAtzkehu_kehumc(){
  			...
  			public void setAtzkhyinhangzh_kaihuyh(String atzkhyinhangzh_kaihuyh){
			this.atzkhyinhangzh_kaihuyh = atzkhyinhangzh_kaihuyh;
		}
		
  		public String getAtzkhyinhangzh_kaihuyh(){
  			return atzkhyinhangzh_kaihuyh;
  		}
  			public void setAtzkhyinhangzh_yinhangzh(String atzkhyinhangzh_yinhangzh){
			this.atzkhyinhangzh_yinhangzh = atzkhyinhangzh_yinhangzh;
		}
		
  		public String getAtzkhyinhangzh_yinhangzh(){
  			return atzkhyinhangzh_yinhangzh;
  		}
  			public void setAtzkhyinhangzh_shuiwudjh(String atzkhyinhangzh_shuiwudjh){
			this.atzkhyinhangzh_shuiwudjh = atzkhyinhangzh_shuiwudjh;
		}
		
  		public String getAtzkhyinhangzh_shuiwudjh(){
  		...
  		public String getAtzkehu_dianhua(){
  			...
  			public void setAtzkaipiaosqd_hejije(Double atzkaipiaosqd_hejije){
			this.atzkaipiaosqd_hejije = atzkaipiaosqd_hejije;
		}
		
  		public Double getAtzkaipiaosqd_hejije(){
  			return atzkaipiaosqd_hejije;
  		}
  			public void setAtzkaipiaosqd_wubizl(Long atzkaipiaosqd_wubizl){
			this.atzkaipiaosqd_wubizl = atzkaipiaosqd_wubizl;
		}
		
  		public Long getAtzkaipiaosqd_wubizl(){
  			return atzkaipiaosqd_wubizl;
  		}
  			public void setAtzkaipiaosqd_dangshihl(Double atzkaipiaosqd_dangshihl){
			this.atzkaipiaosqd_dangshihl = atzkaipiaosqd_dangshihl;
		}
		
  		public Double getAtzkaipiaosqd_dangshihl(){
  			return atzkaipiaosqd_dangshihl;
  		}
  			public void setAtzkaipiaosqd_hejiwbje(Double atzkaipiaosqd_hejiwbje){
			this.atzkaipiaosqd_hejiwbje = atzkaipiaosqd_hejiwbje;
		}
		
  		public Double getAtzkaipiaosqd_hejiwbje(){
  			return atzkaipiaosqd_hejiwbje;
  		}
  			public void setAtzkaipiaosqd_wofangdwmc(String atzkaipiaosqd_wofangdwmc){
			this.atzkaipiaosqd_wofangdwmc = atzkaipiaosqd_wofangdwmc;
		}
		
  		public String getAtzkaipiaosqd_wofangdwmc(){
  			return atzkaipiaosqd_wofangdwmc;
  		}
  			public void setAtzkaipiaosqd_wofangkhyh(String atzkaipiaosqd_wofangkhyh){
			this.atzkaipiaosqd_wofangkhyh = atzkaipiaosqd_wofangkhyh;
		}
		
  		public String getAtzkaipiaosqd_wofangkhyh(){
  			return atzkaipiaosqd_wofangkhyh;
  		}
  			public void setAtzkaipiaosqd_wofangyhzh(String atzkaipiaosqd_wofangyhzh){
			this.atzkaipiaosqd_wofangyhzh = atzkaipiaosqd_wofangyhzh;
		}
		
  		public String getAtzkaipiaosqd_wofangyhzh(){
  			return atzkaipiaosqd_wofangyhzh;
  		}
  			public void setAtzkaipiaosqd_wofangswdjh(String atzkaipiaosqd_wofangswdjh){
			this.atzkaipiaosqd_wofangswdjh = atzkaipiaosqd_wofangswdjh;
		}
		
  		public String getAtzkaipiaosqd_wofangswdjh(){
  			return atzkaipiaosqd_wofangswdjh;
  		}
  			public void setAtzkaipiaosqd_wofangdz(String atzkaipiaosqd_wofangdz){
			this.atzkaipiaosqd_wofangdz = atzkaipiaosqd_wofangdz;
		}
		
  		public String getAtzkaipiaosqd_wofangdz(){
  			return atzkaipiaosqd_wofangdz;
  		}
  			public void setAtzkaipiaosqd_wofangdh(String atzkaipiaosqd_wofangdh){
			this.atzkaipiaosqd_wofangdh = atzkaipiaosqd_wofangdh;
		}
		
  		public String getAtzkaipiaosqd_wofangdh(){
  			return atzkaipiaosqd_wofangdh;
  		}
  			public void setAtzkaipiaosqd_hetongid(Long atzkaipiaosqd_hetongid){
			this.atzkaipiaosqd_hetongid = atzkaipiaosqd_hetongid;
		}
		
  		public Long getAtzkaipiaosqd_hetongid(){
  			return atzkaipiaosqd_hetongid;
  		}
  			public void setAtzkaipiaosqd_linshibh(String atzkaipiaosqd_linshibh){
			this.atzkaipiaosqd_linshibh = atzkaipiaosqd_linshibh;
		}
		
  		public String getAtzkaipiaosqd_linshibh(){
  			return atzkaipiaosqd_linshibh;
  		}
  			public void setAtzkaipiaosqd_kaipiaorq(Date atzkaipiaosqd_kaipiaorq){
			this.atzkaipiaosqd_kaipiaorq = atzkaipiaosqd_kaipiaorq;
		}
		
  		public Date getAtzkaipiaosqd_kaipiaorq(){
  			return atzkaipiaosqd_kaipiaorq;
  		}
  			public void setAtzkaipiaosqd_kehuid(Long atzkaipiaosqd_kehuid){
			this.atzkaipiaosqd_kehuid = atzkaipiaosqd_kehuid;
		}
		
  		public Long getAtzkaipiaosqd_kehuid(){
  			return atzkaipiaosqd_kehuid;
  		}
  			public void setAtzkaipiaosqd_kehuyhzh(Long atzkaipiaosqd_kehuyhzh){
			this.atzkaipiaosqd_kehuyhzh = atzkaipiaosqd_kehuyhzh;
		}
		
  		public Long getAtzkaipiaosqd_kehuyhzh(){
  			return atzkaipiaosqd_kehuyhzh;
  		}
  			public void setAtzkaipiaosqd_yinghangzh(String atzkaipiaosqd_yinghangzh){
			this.atzkaipiaosqd_yinghangzh = atzkaipiaosqd_yinghangzh;
		}
		
  		public String getAtzkaipiaosqd_yinghangzh(){
  			return atzkaipiaosqd_yinghangzh;
  		}
  			public void setAtzkaipiaosqd_danjuzt(String atzkaipiaosqd_danjuzt){
			this.atzkaipiaosqd_danjuzt = atzkaipiaosqd_danjuzt;
		}
		
  		public String getAtzkaipiaosqd_danjuzt(){
  			return atzkaipiaosqd_danjuzt;
  		}
  			public void setAtzkaipiaosqd_zhixingzt(String atzkaipiaosqd_zhixingzt){
			this.atzkaipiaosqd_zhixingzt = atzkaipiaosqd_zhixingzt;
		}
		
  		public String getAtzkaipiaosqd_zhixingzt(){
  			return atzkaipiaosqd_zhixingzt;
  		}
  			public void setAtzkaipiaosqd_shenhezt(String atzkaipiaosqd_shenhezt){
			this.atzkaipiaosqd_shenhezt = atzkaipiaosqd_shenhezt;
		}
		
  		public String getAtzkaipiaosqd_shenhezt(){
  			return atzkaipiaosqd_shenhezt;
  		}
  			public void setAtzkaipiaosqd_shenheyj(String atzkaipiaosqd_shenheyj){
			this.atzkaipiaosqd_shenheyj = atzkaipiaosqd_shenheyj;
		}
		
  		public String getAtzkaipiaosqd_shenheyj(){
  			return atzkaipiaosqd_shenheyj;
  		}
  		...
  		public Long getAtzkehu_xiaoshoujl(){
  			...
  			public void setAtzkhyinhangzh_kehuid(Long atzkhyinhangzh_kehuid){
			this.atzkhyinhangzh_kehuid = atzkhyinhangzh_kehuid;
		}
		
  		public Long getAtzkhyinhangzh_kehuid(){
  			return atzkhyinhangzh_kehuid;
  		}
  			public void setAtzkhyinhangzh_shifouyx(String atzkhyinhangzh_shifouyx){
			this.atzkhyinhangzh_shifouyx = atzkhyinhangzh_shifouyx;
		}
		
  		public String getAtzkhyinhangzh_shifouyx(){
  			return atzkhyinhangzh_shifouyx;
  		}
  			public void setAtzkhyinhangzh_shixiaorq(Date atzkhyinhangzh_shixiaorq){
			this.atzkhyinhangzh_shixiaorq = atzkhyinhangzh_shixiaorq;
		}
		
  		public Date getAtzkhyinhangzh_shixiaorq(){
  			return atzkhyinhangzh_shixiaorq;
  		}
  			public void setAtzkhyinhangzh_lururq(Date atzkhyinhangzh_lururq){
			this.atzkhyinhangzh_lururq = atzkhyinhangzh_lururq;
		}
		
  		public Date getAtzkhyinhangzh_lururq(){
  			return atzkhyinhangzh_lururq;
  		}
  			public void setAtzkhyinhangzh_beizhu(String atzkhyinhangzh_beizhu){
			this.atzkhyinhangzh_beizhu = atzkhyinhangzh_beizhu;
		}
		
  		public String getAtzkhyinhangzh_beizhu(){
  			return atzkhyinhangzh_beizhu;
  		}
  	  	  	public Long getId(){
	  	return getAtzkaipiaosqd_id();
	  }
