...
* Author      :Actiz
* Build Time  :2017-11-28 16:03:39.133
*/
...
public class Phoenix102199fa00000001z implements IAppEntityObject{
	private Long atzemployee_id;
	
			 		private Long atzgangwei_id;
					 		private String atzgangwei_gangweimc = "";
					 		private String atzgangwei_lurur = "";
					 		private Date atzgangwei_lururq;
					 		private String atzgangwei_zuihouxgr = "";
					 		private Date atzgangwei_zuihouxgrq;
					 		private String atzgangwei_beizhu;
					 		...
					 		private Long atzemployee_actizversion;
					 		...
					 		public void setAtzgangwei_id(Long atzgangwei_id){
			this.atzgangwei_id = atzgangwei_id;
		}
			 	public Long getAtzgangwei_id(){
	  		return atzgangwei_id;
	  	}
	    		 		public void setAtzgangwei_gangweimc(String atzgangwei_gangweimc){
			this.atzgangwei_gangweimc = atzgangwei_gangweimc;
		}
			 	public String getAtzgangwei_gangweimc(){
	  		return atzgangwei_gangweimc;
	  	}
	    		 		public void setAtzgangwei_lurur(String atzgangwei_lurur){
			this.atzgangwei_lurur = atzgangwei_lurur;
		}
			 	public String getAtzgangwei_lurur(){
	  		return atzgangwei_lurur;
	  	}
	    		 		public void setAtzgangwei_lururq(Date atzgangwei_lururq){
			this.atzgangwei_lururq = atzgangwei_lururq;
		}
			 	public Date getAtzgangwei_lururq(){
	  		return atzgangwei_lururq;
	  	}
	    		 		public void setAtzgangwei_zuihouxgr(String atzgangwei_zuihouxgr){
			this.atzgangwei_zuihouxgr = atzgangwei_zuihouxgr;
		}
			 	public String getAtzgangwei_zuihouxgr(){
	  		return atzgangwei_zuihouxgr;
	  	}
	    		 		public void setAtzgangwei_zuihouxgrq(Date atzgangwei_zuihouxgrq){
			this.atzgangwei_zuihouxgrq = atzgangwei_zuihouxgrq;
		}
			 	public Date getAtzgangwei_zuihouxgrq(){
	  		return atzgangwei_zuihouxgrq;
	  	}
	    		 		public void setAtzgangwei_beizhu(String atzgangwei_beizhu){
			this.atzgangwei_beizhu = atzgangwei_beizhu;
		}
			 	public String getAtzgangwei_beizhu(){
	  		return atzgangwei_beizhu;
	  	}
			...
			this.atzdepartment_gczgid = atzdepartment_gczgid;
	  		...
	  		return atzdepartment_gczgid;
	    		 		...
	    		 		public void setAtzemployee_actizversion(Long atzemployee_actizversion){
			this.atzemployee_actizversion = atzemployee_actizversion;
		}
			 	public Long getAtzemployee_actizversion(){
	  		return atzemployee_actizversion;
	  	}
