...
* Author      :Actiz
* Build Time  :2017-11-28 16:08:53.395
*/
...
import java.sql.Blob;
	...
	public class Fa8b5206000000007z{
						...
						private Object atzhetong_hetongbh;
							...
							private Object atzhetong_hetongje1;
								private Object atzhetong_hetonglx;
										...
										private Object atzhetong_touruzy;
	  		...
	  		public Object getAtzhetong_htpsxlh(){
	  			return atzhetong_htpsxlh;
  						...
  						public void setAtzhetong_touruzy(Object atzhetong_touruzy){
				this.atzhetong_touruzy = atzhetong_touruzy;
			}
			
	  		public Object getAtzhetong_touruzy(){
  	...
  	public static Fa8b5206000000007z init(DataContextHelper context) {
  		Fa8b5206000000007z o = new Fa8b5206000000007z();
									o.setAtzhetong_hetongbh(getValue(context,"atzhetong.hetongbh"));
										...
										o.setAtzhetong_hetongje1(getValue(context,"atzhetong.hetongje1"));
			  									o.setAtzhetong_hetonglx(getValue(context,"atzhetong.hetonglx"));
						  									...
						  									o.setAtzhetong_touruzy(getValue(context,"atzhetong.touruzy"));
