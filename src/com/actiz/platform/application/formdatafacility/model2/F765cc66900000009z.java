...
* Author      :Actiz
* Build Time  :2017-06-15 14:00:16.333
*/
...
import java.sql.Blob;
	...
	public class F765cc66900000009z{

	
						private Object atzcaigoujhmx_wuliaoid;
			
				
										private Object atzcaigoujh_songhuodz;
	  		...
	  		public Object getAtzcaigoujhmx_wuliaoid(){
	  			return atzcaigoujhmx_wuliaoid;
  						...
  						public void setAtzcaigoujh_songhuodz(Object atzcaigoujh_songhuodz){
				this.atzcaigoujh_songhuodz = atzcaigoujh_songhuodz;
			}
			
	  		public Object getAtzcaigoujh_songhuodz(){
  	...
  	public static F765cc66900000009z init(DataContextHelper context) {
  		F765cc66900000009z o = new F765cc66900000009z();
									o.setAtzcaigoujhmx_wuliaoid(getValue(context,"atzwuliaojcxx.id"));
						
						  									o.setAtzcaigoujh_songhuodz(getValue(context,"atzcaigoujh.songhuodz"));
