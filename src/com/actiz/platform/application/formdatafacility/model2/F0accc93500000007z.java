...
* Author      :Actiz
* Build Time  :2017-11-28 15:57:19.945
*/
...
public class F0accc93500000007z implements IAppEntityObject{
	private Long atzniandukh_id;
	
			 		private Long atzniandukh_actizversion;
					 			 		private String atzniandukh_niandukhbh = "";
					 		private String atzniandukh_nianfen = "";
					 		private String atzniandukh_beikhrbh = "";
					 		private String atzniandukh_beikhzxm = "";
					 		private String atzniandukh_suoshubm = "";
					 		private String atzniandukh_muqiangw = "";
					 		private Date atzniandukh_daozhisj;
					 		private Long atzniandukh_kaoherxm;
					 		private String atzniandukh_kaohergw = "";
					 		private Double atzniandukh_yejizdf = 0.0;
					 		private Double atzniandukh_yejikf = 0.0;
					 		private Double atzniandukh_yejipjdf = 0.0;
					 		private String atzniandukh_zhiyefzjh = "";
					 		private Double atzniandukh_suzhizwpjdf = 0.0;
					 		private Double atzniandukh_suzhizgpjdf = 0.0;
					 		private String atzniandukh_zuihouxgr = "";
					 		private Date atzniandukh_zuihouxgrq;
					 		private String atzniandukh_kaohezxm = "";
					 		private Date atzniandukh_tjrq;
					 		private Long atzniandukh_beikhrxm;
					 		...
					 		public void setAtzniandukh_actizversion(Long atzniandukh_actizversion){
			this.atzniandukh_actizversion = atzniandukh_actizversion;
		}
			 	public Long getAtzniandukh_actizversion(){
	  		return atzniandukh_actizversion;
	  	}
	    		   		 		public void setAtzniandukh_niandukhbh(String atzniandukh_niandukhbh){
			this.atzniandukh_niandukhbh = atzniandukh_niandukhbh;
		}
			 	public String getAtzniandukh_niandukhbh(){
	  		return atzniandukh_niandukhbh;
	  	}
	    		 		public void setAtzniandukh_nianfen(String atzniandukh_nianfen){
			this.atzniandukh_nianfen = atzniandukh_nianfen;
		}
			 	public String getAtzniandukh_nianfen(){
	  		return atzniandukh_nianfen;
	  	}
	    		 		public void setAtzniandukh_beikhrbh(String atzniandukh_beikhrbh){
			this.atzniandukh_beikhrbh = atzniandukh_beikhrbh;
		}
			 	public String getAtzniandukh_beikhrbh(){
	  		return atzniandukh_beikhrbh;
	  	}
	    		 		public void setAtzniandukh_beikhzxm(String atzniandukh_beikhzxm){
			this.atzniandukh_beikhzxm = atzniandukh_beikhzxm;
		}
			 	public String getAtzniandukh_beikhzxm(){
	  		return atzniandukh_beikhzxm;
	  	}
	    		 		public void setAtzniandukh_suoshubm(String atzniandukh_suoshubm){
			this.atzniandukh_suoshubm = atzniandukh_suoshubm;
		}
			 	public String getAtzniandukh_suoshubm(){
	  		return atzniandukh_suoshubm;
	  	}
	    		 		public void setAtzniandukh_muqiangw(String atzniandukh_muqiangw){
			this.atzniandukh_muqiangw = atzniandukh_muqiangw;
		}
			 	public String getAtzniandukh_muqiangw(){
	  		return atzniandukh_muqiangw;
	  	}
	    		 		public void setAtzniandukh_daozhisj(Date atzniandukh_daozhisj){
			this.atzniandukh_daozhisj = atzniandukh_daozhisj;
		}
			 	public Date getAtzniandukh_daozhisj(){
	  		return atzniandukh_daozhisj;
	  	}
	    		 		public void setAtzniandukh_kaoherxm(Long atzniandukh_kaoherxm){
			this.atzniandukh_kaoherxm = atzniandukh_kaoherxm;
		}
			 	public Long getAtzniandukh_kaoherxm(){
	  		return atzniandukh_kaoherxm;
	  	}
	    		 		public void setAtzniandukh_kaohergw(String atzniandukh_kaohergw){
			this.atzniandukh_kaohergw = atzniandukh_kaohergw;
		}
			 	public String getAtzniandukh_kaohergw(){
	  		return atzniandukh_kaohergw;
	  	}
	    		 		public void setAtzniandukh_yejizdf(Double atzniandukh_yejizdf){
			this.atzniandukh_yejizdf = atzniandukh_yejizdf;
		}
			 	public Double getAtzniandukh_yejizdf(){
	  		return atzniandukh_yejizdf;
	  	}
	    		 		public void setAtzniandukh_yejikf(Double atzniandukh_yejikf){
			this.atzniandukh_yejikf = atzniandukh_yejikf;
		}
			 	public Double getAtzniandukh_yejikf(){
	  		return atzniandukh_yejikf;
	  	}
	    		 		public void setAtzniandukh_yejipjdf(Double atzniandukh_yejipjdf){
			this.atzniandukh_yejipjdf = atzniandukh_yejipjdf;
		}
			 	public Double getAtzniandukh_yejipjdf(){
	  		return atzniandukh_yejipjdf;
	  	}
	    		 		public void setAtzniandukh_zhiyefzjh(String atzniandukh_zhiyefzjh){
			this.atzniandukh_zhiyefzjh = atzniandukh_zhiyefzjh;
		}
			 	public String getAtzniandukh_zhiyefzjh(){
	  		return atzniandukh_zhiyefzjh;
	  	}
	    		 		public void setAtzniandukh_suzhizwpjdf(Double atzniandukh_suzhizwpjdf){
			this.atzniandukh_suzhizwpjdf = atzniandukh_suzhizwpjdf;
		}
			 	public Double getAtzniandukh_suzhizwpjdf(){
	  		return atzniandukh_suzhizwpjdf;
	  	}
	    		 		public void setAtzniandukh_suzhizgpjdf(Double atzniandukh_suzhizgpjdf){
			this.atzniandukh_suzhizgpjdf = atzniandukh_suzhizgpjdf;
		}
			 	public Double getAtzniandukh_suzhizgpjdf(){
	  		return atzniandukh_suzhizgpjdf;
	  	}
	    		 		public void setAtzniandukh_zuihouxgr(String atzniandukh_zuihouxgr){
			this.atzniandukh_zuihouxgr = atzniandukh_zuihouxgr;
		}
			 	public String getAtzniandukh_zuihouxgr(){
	  		return atzniandukh_zuihouxgr;
	  	}
	    		 		public void setAtzniandukh_zuihouxgrq(Date atzniandukh_zuihouxgrq){
			this.atzniandukh_zuihouxgrq = atzniandukh_zuihouxgrq;
		}
			 	public Date getAtzniandukh_zuihouxgrq(){
	  		return atzniandukh_zuihouxgrq;
	  	}
	    		 		public void setAtzniandukh_kaohezxm(String atzniandukh_kaohezxm){
			this.atzniandukh_kaohezxm = atzniandukh_kaohezxm;
		}
			 	public String getAtzniandukh_kaohezxm(){
	  		return atzniandukh_kaohezxm;
	  	}
	    		 		public void setAtzniandukh_tjrq(Date atzniandukh_tjrq){
			this.atzniandukh_tjrq = atzniandukh_tjrq;
		}
			 	public Date getAtzniandukh_tjrq(){
	  		return atzniandukh_tjrq;
	  	}
	    		 		public void setAtzniandukh_beikhrxm(Long atzniandukh_beikhrxm){
			this.atzniandukh_beikhrxm = atzniandukh_beikhrxm;
		}
			 	public Long getAtzniandukh_beikhrxm(){
	  		return atzniandukh_beikhrxm;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzniandukh_id(){
  	  	return atzniandukh_id;
  	  }
  	  public void setAtzniandukh_id(Long atzniandukh_id){
  	  	this.atzniandukh_id = atzniandukh_id;
  	  }
	  public Long getId(){
	  	return getAtzniandukh_id();
	  }
