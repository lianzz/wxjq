...
* Author      :Actiz
* Build Time  :2017-06-15 13:54:31.563
*/
...
public class F32f0f8b900000001z implements IAppEntityObject{
	private Long atzhtbcxy_id;
	
			 		private Long atzhtbcxy_actizversion;
					 			 		private Long atzhtbcxy_hetongid;
					 		private String atzhtbcxy_fujian;
					 		private Long atzhtbcxy_lururid;
					 		private String atzhtbcxy_lurur = "";
					 		private Date atzhtbcxy_lururq;
					 		private Long atzhtbcxy_zuihouxgrid;
					 		private String atzhtbcxy_zuihouxgr = "";
					 		private Date atzhtbcxy_zuihouxgrq;
					 		...
					 		public void setAtzhtbcxy_actizversion(Long atzhtbcxy_actizversion){
			this.atzhtbcxy_actizversion = atzhtbcxy_actizversion;
		}
			 	public Long getAtzhtbcxy_actizversion(){
	  		return atzhtbcxy_actizversion;
	  	}
	    		   		 		public void setAtzhtbcxy_hetongid(Long atzhtbcxy_hetongid){
			this.atzhtbcxy_hetongid = atzhtbcxy_hetongid;
		}
			 	public Long getAtzhtbcxy_hetongid(){
	  		return atzhtbcxy_hetongid;
	  	}
	    		 		public void setAtzhtbcxy_fujian(String atzhtbcxy_fujian){
			this.atzhtbcxy_fujian = atzhtbcxy_fujian;
		}
			 	public String getAtzhtbcxy_fujian(){
	  		return atzhtbcxy_fujian;
	  	}
	    		 		public void setAtzhtbcxy_lururid(Long atzhtbcxy_lururid){
			this.atzhtbcxy_lururid = atzhtbcxy_lururid;
		}
			 	public Long getAtzhtbcxy_lururid(){
	  		return atzhtbcxy_lururid;
	  	}
	    		 		public void setAtzhtbcxy_lurur(String atzhtbcxy_lurur){
			this.atzhtbcxy_lurur = atzhtbcxy_lurur;
		}
			 	public String getAtzhtbcxy_lurur(){
	  		return atzhtbcxy_lurur;
	  	}
	    		 		public void setAtzhtbcxy_lururq(Date atzhtbcxy_lururq){
			this.atzhtbcxy_lururq = atzhtbcxy_lururq;
		}
			 	public Date getAtzhtbcxy_lururq(){
	  		return atzhtbcxy_lururq;
	  	}
	    		 		public void setAtzhtbcxy_zuihouxgrid(Long atzhtbcxy_zuihouxgrid){
			this.atzhtbcxy_zuihouxgrid = atzhtbcxy_zuihouxgrid;
		}
			 	public Long getAtzhtbcxy_zuihouxgrid(){
	  		return atzhtbcxy_zuihouxgrid;
	  	}
	    		 		public void setAtzhtbcxy_zuihouxgr(String atzhtbcxy_zuihouxgr){
			this.atzhtbcxy_zuihouxgr = atzhtbcxy_zuihouxgr;
		}
			 	public String getAtzhtbcxy_zuihouxgr(){
	  		return atzhtbcxy_zuihouxgr;
	  	}
	    		 		public void setAtzhtbcxy_zuihouxgrq(Date atzhtbcxy_zuihouxgrq){
			this.atzhtbcxy_zuihouxgrq = atzhtbcxy_zuihouxgrq;
		}
			 	public Date getAtzhtbcxy_zuihouxgrq(){
	  		return atzhtbcxy_zuihouxgrq;
	  	}
			...
			this.atzhetong_czxiaoshoufz = atzhetong_czxiaoshoufz;
	  		...
	  		return atzhetong_czxiaoshoufz;
	    	  	  ...
	    	  	  public Long getAtzhtbcxy_id(){
  	  	return atzhtbcxy_id;
  	  }
  	  public void setAtzhtbcxy_id(Long atzhtbcxy_id){
  	  	this.atzhtbcxy_id = atzhtbcxy_id;
  	  }
	  public Long getId(){
	  	return getAtzhtbcxy_id();
	  }
