...
import java.sql.Blob;
	public class Fabca960a00000002z implements IAppEntityObject{
	private Long atzrenshibd_id;
			 		...
			 		private Long atzdepartment_id;
					 		...
					 		private String atzdepartment1_orgname = "";
					 		private String atzdepartment1_yewulx = "";
					 		private Long atzdepartment1_managerid;
					 		private String atzdepartment1_tel = "";
					 		private Long atzdepartment1_fudepartid;
					 		private String atzdepartment1_lujing;
					 		private Integer atzdepartment1_statuss = 0;
					 		private String atzdepartment1_lurur = "";
					 		private Date atzdepartment1_lururq;
					 		private String atzdepartment1_zuihouxgr = "";
					 		...
					 		private String atzrenshibd_churulx = "";
					 		private Long atzrenshibd_xianbm;
					 		private Long atzrenshibd_xiangw;
					 		private Long atzrenshibd_nibiandongbm;
					 		private Long atzrenshibd_nibiandonggw;
					 		private Date atzrenshibd_nibiandongsj;
					 		private String atzrenshibd_gangweibdyy;
					 		private String atzrenshibd_lurur = "";
					 		private String atzrenshibd_zuihouxgr = "";
					 		private Date atzrenshibd_lururq;
					 		private Date atzrenshibd_zuihouxgrq;
					 		private Long atzrenshibd_lururid;
					 		private Long atzrenshibd_zuihouxgrid;
			...
			this.atzdepartment1_id = atzdepartment1_id;
			 	...
			 	public Long getAtzdepartment1_id(){
	  		return atzdepartment1_id;
	  	}
	    		 		public void setAtzdepartment1_cengci(Integer atzdepartment1_cengci){
			this.atzdepartment1_cengci = atzdepartment1_cengci;
		}
			 	public Integer getAtzdepartment1_cengci(){
	  		return atzdepartment1_cengci;
	  	}
	    		 		public void setAtzdepartment1_orgcode(String atzdepartment1_orgcode){
			this.atzdepartment1_orgcode = atzdepartment1_orgcode;
		}
			 	public String getAtzdepartment1_orgcode(){
	  		return atzdepartment1_orgcode;
	  	}
	    		 		public void setAtzdepartment1_orgname(String atzdepartment1_orgname){
			this.atzdepartment1_orgname = atzdepartment1_orgname;
		}
			 	public String getAtzdepartment1_orgname(){
	  		return atzdepartment1_orgname;
	  	}
	    		 		public void setAtzdepartment1_yewulx(String atzdepartment1_yewulx){
			this.atzdepartment1_yewulx = atzdepartment1_yewulx;
		}
			 	public String getAtzdepartment1_yewulx(){
	  		return atzdepartment1_yewulx;
	  	}
	    		 		public void setAtzdepartment1_managerid(Long atzdepartment1_managerid){
			this.atzdepartment1_managerid = atzdepartment1_managerid;
		}
			 	public Long getAtzdepartment1_managerid(){
	  		return atzdepartment1_managerid;
	  	}
	    		 		public void setAtzdepartment1_tel(String atzdepartment1_tel){
			this.atzdepartment1_tel = atzdepartment1_tel;
		}
			 	public String getAtzdepartment1_tel(){
	  		return atzdepartment1_tel;
	  	}
	    		 		public void setAtzdepartment1_fudepartid(Long atzdepartment1_fudepartid){
			this.atzdepartment1_fudepartid = atzdepartment1_fudepartid;
		}
			 	public Long getAtzdepartment1_fudepartid(){
	  		return atzdepartment1_fudepartid;
	  	}
	    		 		public void setAtzdepartment1_lujing(String atzdepartment1_lujing){
			this.atzdepartment1_lujing = atzdepartment1_lujing;
		}
			 	public String getAtzdepartment1_lujing(){
	  		return atzdepartment1_lujing;
	  	}
	    		 		public void setAtzdepartment1_statuss(Integer atzdepartment1_statuss){
			this.atzdepartment1_statuss = atzdepartment1_statuss;
		}
			 	public Integer getAtzdepartment1_statuss(){
	  		return atzdepartment1_statuss;
	  	}
	    		 		public void setAtzdepartment1_lurur(String atzdepartment1_lurur){
			this.atzdepartment1_lurur = atzdepartment1_lurur;
		}
			 	public String getAtzdepartment1_lurur(){
	  		return atzdepartment1_lurur;
	  	}
	    		 		public void setAtzdepartment1_lururq(Date atzdepartment1_lururq){
			this.atzdepartment1_lururq = atzdepartment1_lururq;
		}
			 	public Date getAtzdepartment1_lururq(){
	  		return atzdepartment1_lururq;
	  	}
	    		 		public void setAtzdepartment1_zuihouxgr(String atzdepartment1_zuihouxgr){
			this.atzdepartment1_zuihouxgr = atzdepartment1_zuihouxgr;
		}
			 	public String getAtzdepartment1_zuihouxgr(){
	  		return atzdepartment1_zuihouxgr;
	  	}
	    		 		public void setAtzdepartment1_zuihouxgrq(Date atzdepartment1_zuihouxgrq){
			this.atzdepartment1_zuihouxgrq = atzdepartment1_zuihouxgrq;
		}
			 	public Date getAtzdepartment1_zuihouxgrq(){
	  		return atzdepartment1_zuihouxgrq;
	  	}
	    		 		public void setAtzdepartment1_lururid(Long atzdepartment1_lururid){
			this.atzdepartment1_lururid = atzdepartment1_lururid;
		}
			 	public Long getAtzdepartment1_lururid(){
	  		return atzdepartment1_lururid;
	  	}
	    		 		public void setAtzdepartment1_zuihouxgrid(Long atzdepartment1_zuihouxgrid){
			this.atzdepartment1_zuihouxgrid = atzdepartment1_zuihouxgrid;
		}
			...
			this.atzrenshibd_actizversion = atzrenshibd_actizversion;
			 	...
			 	public Long getAtzrenshibd_actizversion(){
	  		return atzrenshibd_actizversion;
	  	}
	    		   		 		public void setAtzrenshibd_yuangong(Long atzrenshibd_yuangong){
			this.atzrenshibd_yuangong = atzrenshibd_yuangong;
		}
			 	public Long getAtzrenshibd_yuangong(){
	  		return atzrenshibd_yuangong;
	  	}
	    		 		public void setAtzrenshibd_churuqk(String atzrenshibd_churuqk){
			this.atzrenshibd_churuqk = atzrenshibd_churuqk;
		}
			 	public String getAtzrenshibd_churuqk(){
	  		return atzrenshibd_churuqk;
	  	}
	    		 		public void setAtzrenshibd_churulx(String atzrenshibd_churulx){
			this.atzrenshibd_churulx = atzrenshibd_churulx;
		}
			 	public String getAtzrenshibd_churulx(){
	  		return atzrenshibd_churulx;
	  	}
	    		 		public void setAtzrenshibd_xianbm(Long atzrenshibd_xianbm){
			this.atzrenshibd_xianbm = atzrenshibd_xianbm;
		}
			 	public Long getAtzrenshibd_xianbm(){
	  		return atzrenshibd_xianbm;
	  	}
	    		 		public void setAtzrenshibd_xiangw(Long atzrenshibd_xiangw){
			this.atzrenshibd_xiangw = atzrenshibd_xiangw;
		}
			 	public Long getAtzrenshibd_xiangw(){
	  		return atzrenshibd_xiangw;
	  	}
	    		 		public void setAtzrenshibd_nibiandongbm(Long atzrenshibd_nibiandongbm){
			this.atzrenshibd_nibiandongbm = atzrenshibd_nibiandongbm;
		}
			 	public Long getAtzrenshibd_nibiandongbm(){
	  		return atzrenshibd_nibiandongbm;
	  	}
	    		 		public void setAtzrenshibd_nibiandonggw(Long atzrenshibd_nibiandonggw){
			this.atzrenshibd_nibiandonggw = atzrenshibd_nibiandonggw;
		}
			 	public Long getAtzrenshibd_nibiandonggw(){
	  		return atzrenshibd_nibiandonggw;
	  	}
	    		 		public void setAtzrenshibd_nibiandongsj(Date atzrenshibd_nibiandongsj){
			this.atzrenshibd_nibiandongsj = atzrenshibd_nibiandongsj;
		}
			 	public Date getAtzrenshibd_nibiandongsj(){
	  		return atzrenshibd_nibiandongsj;
	  	}
	    		 		public void setAtzrenshibd_gangweibdyy(String atzrenshibd_gangweibdyy){
			this.atzrenshibd_gangweibdyy = atzrenshibd_gangweibdyy;
		}
			 	public String getAtzrenshibd_gangweibdyy(){
	  		return atzrenshibd_gangweibdyy;
	  	}
	    		 		public void setAtzrenshibd_lurur(String atzrenshibd_lurur){
			this.atzrenshibd_lurur = atzrenshibd_lurur;
		}
			 	public String getAtzrenshibd_lurur(){
	  		return atzrenshibd_lurur;
	  	}
	    		 		public void setAtzrenshibd_zuihouxgr(String atzrenshibd_zuihouxgr){
			this.atzrenshibd_zuihouxgr = atzrenshibd_zuihouxgr;
		}
			 	public String getAtzrenshibd_zuihouxgr(){
	  		return atzrenshibd_zuihouxgr;
	  	}
	    		 		public void setAtzrenshibd_lururq(Date atzrenshibd_lururq){
			this.atzrenshibd_lururq = atzrenshibd_lururq;
		}
			 	public Date getAtzrenshibd_lururq(){
	  		return atzrenshibd_lururq;
	  	}
	    		 		public void setAtzrenshibd_zuihouxgrq(Date atzrenshibd_zuihouxgrq){
			this.atzrenshibd_zuihouxgrq = atzrenshibd_zuihouxgrq;
		}
			 	public Date getAtzrenshibd_zuihouxgrq(){
	  		return atzrenshibd_zuihouxgrq;
	  	}
	    		 		public void setAtzrenshibd_lururid(Long atzrenshibd_lururid){
			this.atzrenshibd_lururid = atzrenshibd_lururid;
		}
			 	public Long getAtzrenshibd_lururid(){
	  		return atzrenshibd_lururid;
	  	}
	    		 		public void setAtzrenshibd_zuihouxgrid(Long atzrenshibd_zuihouxgrid){
			this.atzrenshibd_zuihouxgrid = atzrenshibd_zuihouxgrid;
		}
			 	public Long getAtzrenshibd_zuihouxgrid(){
	  		return atzrenshibd_zuihouxgrid;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzrenshibd_id(){
  	  	return atzrenshibd_id;
  	  }
  	  public void setAtzrenshibd_id(Long atzrenshibd_id){
  	  	this.atzrenshibd_id = atzrenshibd_id;
  	  }
	  public Long getId(){
	  	return getAtzrenshibd_id();
	  }
