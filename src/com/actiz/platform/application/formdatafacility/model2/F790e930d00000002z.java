...
* Author      :Actiz
* Build Time  :2017-11-28 15:58:27.849
*/
...
public class F790e930d00000002z implements IAppEntityObject{
	private Long atzhetonggz_id;
			 		...
			 		private Long atzkehuxtxx_id;
					 		...
					 		private Long atzhetonggz_actizversion;
					 			 		private Long atzhetonggz_hetongid;
					 		private Long atzhetonggz_xitongid;
					 		private String atzhetonggz_genzonglx = "";
					 		private Date atzhetonggz_jihuasj;
					 		private Date atzhetonggz_shijisj;
					 		private String atzhetonggz_zhidanr = "";
					 		private Date atzhetonggz_zhidanrq;
					 		private String atzhetonggz_zuihouxgr = "";
					 		private Date atzhetonggz_zuihouxgrq;
					 		private String atzhetonggz_wfqianshour = "";
					 		private String atzhetonggz_dfqianshour = "";
					 		private Date atzhetonggz_wfqianshourq;
					 		private Long atzhetonggz_fahuotzdid;
					 		private String atzhetonggz_beizhu = "";
					 		private String atzhetonggz_hetongcplx = "";
					 		private String atzhetonggz_fujian;
			...
			this.atzkehuxtxx_chanpinid = atzkehuxtxx_chanpinid;
	  		...
	  		return atzkehuxtxx_chanpinid;
	    		 		...
	    		 		public void setAtzhetonggz_actizversion(Long atzhetonggz_actizversion){
			this.atzhetonggz_actizversion = atzhetonggz_actizversion;
		}
			 	public Long getAtzhetonggz_actizversion(){
	  		return atzhetonggz_actizversion;
	  	}
	    		   		 		public void setAtzhetonggz_hetongid(Long atzhetonggz_hetongid){
			this.atzhetonggz_hetongid = atzhetonggz_hetongid;
		}
			 	public Long getAtzhetonggz_hetongid(){
	  		return atzhetonggz_hetongid;
	  	}
	    		 		public void setAtzhetonggz_xitongid(Long atzhetonggz_xitongid){
			this.atzhetonggz_xitongid = atzhetonggz_xitongid;
		}
			 	public Long getAtzhetonggz_xitongid(){
	  		return atzhetonggz_xitongid;
	  	}
	    		 		public void setAtzhetonggz_genzonglx(String atzhetonggz_genzonglx){
			this.atzhetonggz_genzonglx = atzhetonggz_genzonglx;
		}
			 	public String getAtzhetonggz_genzonglx(){
	  		return atzhetonggz_genzonglx;
	  	}
	    		 		public void setAtzhetonggz_jihuasj(Date atzhetonggz_jihuasj){
			this.atzhetonggz_jihuasj = atzhetonggz_jihuasj;
		}
			 	public Date getAtzhetonggz_jihuasj(){
	  		return atzhetonggz_jihuasj;
	  	}
	    		 		public void setAtzhetonggz_shijisj(Date atzhetonggz_shijisj){
			this.atzhetonggz_shijisj = atzhetonggz_shijisj;
		}
			 	public Date getAtzhetonggz_shijisj(){
	  		return atzhetonggz_shijisj;
	  	}
	    		 		public void setAtzhetonggz_zhidanr(String atzhetonggz_zhidanr){
			this.atzhetonggz_zhidanr = atzhetonggz_zhidanr;
		}
			 	public String getAtzhetonggz_zhidanr(){
	  		return atzhetonggz_zhidanr;
	  	}
	    		 		public void setAtzhetonggz_zhidanrq(Date atzhetonggz_zhidanrq){
			this.atzhetonggz_zhidanrq = atzhetonggz_zhidanrq;
		}
			 	public Date getAtzhetonggz_zhidanrq(){
	  		return atzhetonggz_zhidanrq;
	  	}
	    		 		public void setAtzhetonggz_zuihouxgr(String atzhetonggz_zuihouxgr){
			this.atzhetonggz_zuihouxgr = atzhetonggz_zuihouxgr;
		}
			 	public String getAtzhetonggz_zuihouxgr(){
	  		return atzhetonggz_zuihouxgr;
	  	}
	    		 		public void setAtzhetonggz_zuihouxgrq(Date atzhetonggz_zuihouxgrq){
			this.atzhetonggz_zuihouxgrq = atzhetonggz_zuihouxgrq;
		}
			 	public Date getAtzhetonggz_zuihouxgrq(){
	  		return atzhetonggz_zuihouxgrq;
	  	}
	    		 		public void setAtzhetonggz_wfqianshour(String atzhetonggz_wfqianshour){
			this.atzhetonggz_wfqianshour = atzhetonggz_wfqianshour;
		}
			 	public String getAtzhetonggz_wfqianshour(){
	  		return atzhetonggz_wfqianshour;
	  	}
	    		 		public void setAtzhetonggz_dfqianshour(String atzhetonggz_dfqianshour){
			this.atzhetonggz_dfqianshour = atzhetonggz_dfqianshour;
		}
			 	public String getAtzhetonggz_dfqianshour(){
	  		return atzhetonggz_dfqianshour;
	  	}
	    		 		public void setAtzhetonggz_wfqianshourq(Date atzhetonggz_wfqianshourq){
			this.atzhetonggz_wfqianshourq = atzhetonggz_wfqianshourq;
		}
			 	public Date getAtzhetonggz_wfqianshourq(){
	  		return atzhetonggz_wfqianshourq;
	  	}
	    		 		public void setAtzhetonggz_fahuotzdid(Long atzhetonggz_fahuotzdid){
			this.atzhetonggz_fahuotzdid = atzhetonggz_fahuotzdid;
		}
			 	public Long getAtzhetonggz_fahuotzdid(){
	  		return atzhetonggz_fahuotzdid;
	  	}
	    		 		public void setAtzhetonggz_beizhu(String atzhetonggz_beizhu){
			this.atzhetonggz_beizhu = atzhetonggz_beizhu;
		}
			 	public String getAtzhetonggz_beizhu(){
	  		return atzhetonggz_beizhu;
	  	}
	    		 		public void setAtzhetonggz_hetongcplx(String atzhetonggz_hetongcplx){
			this.atzhetonggz_hetongcplx = atzhetonggz_hetongcplx;
		}
			 	public String getAtzhetonggz_hetongcplx(){
	  		return atzhetonggz_hetongcplx;
	  	}
	    		 		public void setAtzhetonggz_fujian(String atzhetonggz_fujian){
			this.atzhetonggz_fujian = atzhetonggz_fujian;
		}
			 	public String getAtzhetonggz_fujian(){
	  		return atzhetonggz_fujian;
	  	}
			...
			this.atzfahuotzd_xmpzqdid = atzfahuotzd_xmpzqdid;
	  		...
	  		return atzfahuotzd_xmpzqdid;
	    	  	  ...
	    	  	  public Long getAtzhetonggz_id(){
  	  	return atzhetonggz_id;
  	  }
  	  public void setAtzhetonggz_id(Long atzhetonggz_id){
  	  	this.atzhetonggz_id = atzhetonggz_id;
  	  }
	  public Long getId(){
	  	return getAtzhetonggz_id();
	  }
