...
* Author      :Actiz
* Build Time  :2017-11-28 15:57:15.078
*/
...
public class F8bd8c40500000001z implements IAppEntityObject{
	private Long atzshebeiwbxx_id;
			 		...
			 		private Long atzwuliaojcxx_id;
					 		...
					 		private Long atzshebeiwbxx_actizversion;
					 			 		private Long atzshebeiwbxx_kehuid;
					 		private String atzshebeiwbxx_sn = "";
					 		private Long atzshebeiwbxx_wuliaoid;
					 		private Long atzshebeiwbxx_weibaohtid;
					 		private Long atzshebeiwbxx_xiaoshouhtid;
					 		private String atzshebeiwbxx_shifouyx = "";
			...
			this.atzwuliaojcxx_xsbmdanjuzt = atzwuliaojcxx_xsbmdanjuzt;
	  		...
	  		return atzwuliaojcxx_xsbmdanjuzt;
	    		 		...
	    		 		public void setAtzshebeiwbxx_actizversion(Long atzshebeiwbxx_actizversion){
			this.atzshebeiwbxx_actizversion = atzshebeiwbxx_actizversion;
		}
			 	public Long getAtzshebeiwbxx_actizversion(){
	  		return atzshebeiwbxx_actizversion;
	  	}
	    		   		 		public void setAtzshebeiwbxx_kehuid(Long atzshebeiwbxx_kehuid){
			this.atzshebeiwbxx_kehuid = atzshebeiwbxx_kehuid;
		}
			 	public Long getAtzshebeiwbxx_kehuid(){
	  		return atzshebeiwbxx_kehuid;
	  	}
	    		 		public void setAtzshebeiwbxx_sn(String atzshebeiwbxx_sn){
			this.atzshebeiwbxx_sn = atzshebeiwbxx_sn;
		}
			 	public String getAtzshebeiwbxx_sn(){
	  		return atzshebeiwbxx_sn;
	  	}
	    		 		public void setAtzshebeiwbxx_wuliaoid(Long atzshebeiwbxx_wuliaoid){
			this.atzshebeiwbxx_wuliaoid = atzshebeiwbxx_wuliaoid;
		}
			 	public Long getAtzshebeiwbxx_wuliaoid(){
	  		return atzshebeiwbxx_wuliaoid;
	  	}
	    		 		public void setAtzshebeiwbxx_weibaohtid(Long atzshebeiwbxx_weibaohtid){
			this.atzshebeiwbxx_weibaohtid = atzshebeiwbxx_weibaohtid;
		}
			 	public Long getAtzshebeiwbxx_weibaohtid(){
	  		return atzshebeiwbxx_weibaohtid;
	  	}
	    		 		public void setAtzshebeiwbxx_xiaoshouhtid(Long atzshebeiwbxx_xiaoshouhtid){
			this.atzshebeiwbxx_xiaoshouhtid = atzshebeiwbxx_xiaoshouhtid;
		}
			 	public Long getAtzshebeiwbxx_xiaoshouhtid(){
	  		return atzshebeiwbxx_xiaoshouhtid;
	  	}
	    		 		public void setAtzshebeiwbxx_shifouyx(String atzshebeiwbxx_shifouyx){
			this.atzshebeiwbxx_shifouyx = atzshebeiwbxx_shifouyx;
		}
			 	public String getAtzshebeiwbxx_shifouyx(){
	  		return atzshebeiwbxx_shifouyx;
	  	}
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    	  	  ...
	    	  	  public Long getAtzshebeiwbxx_id(){
  	  	return atzshebeiwbxx_id;
  	  }
  	  public void setAtzshebeiwbxx_id(Long atzshebeiwbxx_id){
  	  	this.atzshebeiwbxx_id = atzshebeiwbxx_id;
  	  }
	  public Long getId(){
	  	return getAtzshebeiwbxx_id();
	  }
