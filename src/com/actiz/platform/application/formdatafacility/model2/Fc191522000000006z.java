...
* Author      :Actiz
* Build Time  :2017-11-28 16:01:21.787
*/
...
public class Fc191522000000006z implements IAppEntityObject{
	private Long atzqingjia_id;
	
			 		private Long atzqingjia_actizversion;
					 			 		private String atzqingjia_qingjiadbh = "";
					 		private String atzqingjia_yuangongbh = "";
					 		private Long atzqingjia_qingjiayg;
					 		private String atzqingjia_qingjiabm = "";
					 		private String atzqingjia_yuangongzw = "";
					 		private Date atzqingjia_qingjiakssj;
					 		private Date atzqingjia_qingjiajssj;
					 		private Long atzqingjia_qingjiasc;
					 		private String atzqingjia_beizhuxx;
					 		private String atzqingjia_luruyg = "";
					 		private Timestamp atzqingjia_lurusj;
					 		private String atzqingjia_qingjialb = "";
					 		private String atzqingjia_shenhezt = "";
					 		private String atzqingjia_shyjzt = "0";
					 		...
					 		public void setAtzqingjia_actizversion(Long atzqingjia_actizversion){
			this.atzqingjia_actizversion = atzqingjia_actizversion;
		}
			 	public Long getAtzqingjia_actizversion(){
	  		return atzqingjia_actizversion;
	  	}
	    		   		 		public void setAtzqingjia_qingjiadbh(String atzqingjia_qingjiadbh){
			this.atzqingjia_qingjiadbh = atzqingjia_qingjiadbh;
		}
			 	public String getAtzqingjia_qingjiadbh(){
	  		return atzqingjia_qingjiadbh;
	  	}
	    		 		public void setAtzqingjia_yuangongbh(String atzqingjia_yuangongbh){
			this.atzqingjia_yuangongbh = atzqingjia_yuangongbh;
		}
			 	public String getAtzqingjia_yuangongbh(){
	  		return atzqingjia_yuangongbh;
	  	}
	    		 		public void setAtzqingjia_qingjiayg(Long atzqingjia_qingjiayg){
			this.atzqingjia_qingjiayg = atzqingjia_qingjiayg;
		}
			 	public Long getAtzqingjia_qingjiayg(){
	  		return atzqingjia_qingjiayg;
	  	}
	    		 		public void setAtzqingjia_qingjiabm(String atzqingjia_qingjiabm){
			this.atzqingjia_qingjiabm = atzqingjia_qingjiabm;
		}
			 	public String getAtzqingjia_qingjiabm(){
	  		return atzqingjia_qingjiabm;
	  	}
	    		 		public void setAtzqingjia_yuangongzw(String atzqingjia_yuangongzw){
			this.atzqingjia_yuangongzw = atzqingjia_yuangongzw;
		}
			 	public String getAtzqingjia_yuangongzw(){
	  		return atzqingjia_yuangongzw;
	  	}
	    		 		public void setAtzqingjia_qingjiakssj(Date atzqingjia_qingjiakssj){
			this.atzqingjia_qingjiakssj = atzqingjia_qingjiakssj;
		}
			 	public Date getAtzqingjia_qingjiakssj(){
	  		return atzqingjia_qingjiakssj;
	  	}
	    		 		public void setAtzqingjia_qingjiajssj(Date atzqingjia_qingjiajssj){
			this.atzqingjia_qingjiajssj = atzqingjia_qingjiajssj;
		}
			 	public Date getAtzqingjia_qingjiajssj(){
	  		return atzqingjia_qingjiajssj;
	  	}
	    		 		public void setAtzqingjia_qingjiasc(Long atzqingjia_qingjiasc){
			this.atzqingjia_qingjiasc = atzqingjia_qingjiasc;
		}
			 	public Long getAtzqingjia_qingjiasc(){
	  		return atzqingjia_qingjiasc;
	  	}
	    		 		public void setAtzqingjia_beizhuxx(String atzqingjia_beizhuxx){
			this.atzqingjia_beizhuxx = atzqingjia_beizhuxx;
		}
			 	public String getAtzqingjia_beizhuxx(){
	  		return atzqingjia_beizhuxx;
	  	}
	    		 		public void setAtzqingjia_luruyg(String atzqingjia_luruyg){
			this.atzqingjia_luruyg = atzqingjia_luruyg;
		}
			 	public String getAtzqingjia_luruyg(){
	  		return atzqingjia_luruyg;
	  	}
	    		 		public void setAtzqingjia_lurusj(Timestamp atzqingjia_lurusj){
			this.atzqingjia_lurusj = atzqingjia_lurusj;
		}
			 	public Timestamp getAtzqingjia_lurusj(){
	  		return atzqingjia_lurusj;
	  	}
	    		 		public void setAtzqingjia_qingjialb(String atzqingjia_qingjialb){
			this.atzqingjia_qingjialb = atzqingjia_qingjialb;
		}
			 	public String getAtzqingjia_qingjialb(){
	  		return atzqingjia_qingjialb;
	  	}
	    		 		public void setAtzqingjia_shenhezt(String atzqingjia_shenhezt){
			this.atzqingjia_shenhezt = atzqingjia_shenhezt;
		}
			 	public String getAtzqingjia_shenhezt(){
	  		return atzqingjia_shenhezt;
	  	}
	    		 		public void setAtzqingjia_shyjzt(String atzqingjia_shyjzt){
			this.atzqingjia_shyjzt = atzqingjia_shyjzt;
		}
			 	public String getAtzqingjia_shyjzt(){
	  		return atzqingjia_shyjzt;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzqingjia_id(){
  	  	return atzqingjia_id;
  	  }
  	  public void setAtzqingjia_id(Long atzqingjia_id){
  	  	this.atzqingjia_id = atzqingjia_id;
  	  }
	  public Long getId(){
	  	return getAtzqingjia_id();
	  }
