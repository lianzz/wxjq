...
* Author      :Actiz
* Build Time  :2017-06-15 13:46:38.854
*/
...
public class Fe52182b100000002z implements IAppEntityObject{
	private Long atzkecheng_id;
			 		...
			 		private Long atzdepartment_id;
					 		...
					 		private Long atzkecheng_actizversion;
					 			 		private String atzkecheng_kechengmc = "";
					 		private Long atzkecheng_yuangong;
					 		private Long atzkecheng_bumen;
					 		private Double atzkecheng_keshi = 0.0;
					 		private String atzkecheng_kclb = "";
					 		private String atzkecheng_mxdx = "";
					 		private String atzkecheng_shijiangjl;
					 		private String atzkecheng_beizhu;
					 		private String atzkecheng_fujian;
					 		private String atzkecheng_lurur = "";
					 		private Long atzkecheng_lururid;
					 		private Date atzkecheng_lururq;
					 		private String atzkecheng_zuihouxgr = "";
					 		private Long atzkecheng_zuihouxgrid;
					 		private Date atzkecheng_zuihouxgrq;
					 		private String atzkecheng_danjuzt = "";
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    		 		...
	    		 		public void setAtzkecheng_actizversion(Long atzkecheng_actizversion){
			this.atzkecheng_actizversion = atzkecheng_actizversion;
		}
			 	public Long getAtzkecheng_actizversion(){
	  		return atzkecheng_actizversion;
	  	}
	    		   		 		public void setAtzkecheng_kechengmc(String atzkecheng_kechengmc){
			this.atzkecheng_kechengmc = atzkecheng_kechengmc;
		}
			 	public String getAtzkecheng_kechengmc(){
	  		return atzkecheng_kechengmc;
	  	}
	    		 		public void setAtzkecheng_yuangong(Long atzkecheng_yuangong){
			this.atzkecheng_yuangong = atzkecheng_yuangong;
		}
			 	public Long getAtzkecheng_yuangong(){
	  		return atzkecheng_yuangong;
	  	}
	    		 		public void setAtzkecheng_bumen(Long atzkecheng_bumen){
			this.atzkecheng_bumen = atzkecheng_bumen;
		}
			 	public Long getAtzkecheng_bumen(){
	  		return atzkecheng_bumen;
	  	}
	    		 		public void setAtzkecheng_keshi(Double atzkecheng_keshi){
			this.atzkecheng_keshi = atzkecheng_keshi;
		}
			 	public Double getAtzkecheng_keshi(){
	  		return atzkecheng_keshi;
	  	}
	    		 		public void setAtzkecheng_kclb(String atzkecheng_kclb){
			this.atzkecheng_kclb = atzkecheng_kclb;
		}
			 	public String getAtzkecheng_kclb(){
	  		return atzkecheng_kclb;
	  	}
	    		 		public void setAtzkecheng_mxdx(String atzkecheng_mxdx){
			this.atzkecheng_mxdx = atzkecheng_mxdx;
		}
			 	public String getAtzkecheng_mxdx(){
	  		return atzkecheng_mxdx;
	  	}
	    		 		public void setAtzkecheng_shijiangjl(String atzkecheng_shijiangjl){
			this.atzkecheng_shijiangjl = atzkecheng_shijiangjl;
		}
			 	public String getAtzkecheng_shijiangjl(){
	  		return atzkecheng_shijiangjl;
	  	}
	    		 		public void setAtzkecheng_beizhu(String atzkecheng_beizhu){
			this.atzkecheng_beizhu = atzkecheng_beizhu;
		}
			 	public String getAtzkecheng_beizhu(){
	  		return atzkecheng_beizhu;
	  	}
	    		 		public void setAtzkecheng_fujian(String atzkecheng_fujian){
			this.atzkecheng_fujian = atzkecheng_fujian;
		}
			 	public String getAtzkecheng_fujian(){
	  		return atzkecheng_fujian;
	  	}
	    		 		public void setAtzkecheng_lurur(String atzkecheng_lurur){
			this.atzkecheng_lurur = atzkecheng_lurur;
		}
			 	public String getAtzkecheng_lurur(){
	  		return atzkecheng_lurur;
	  	}
	    		 		public void setAtzkecheng_lururid(Long atzkecheng_lururid){
			this.atzkecheng_lururid = atzkecheng_lururid;
		}
			 	public Long getAtzkecheng_lururid(){
	  		return atzkecheng_lururid;
	  	}
	    		 		public void setAtzkecheng_lururq(Date atzkecheng_lururq){
			this.atzkecheng_lururq = atzkecheng_lururq;
		}
			 	public Date getAtzkecheng_lururq(){
	  		return atzkecheng_lururq;
	  	}
	    		 		public void setAtzkecheng_zuihouxgr(String atzkecheng_zuihouxgr){
			this.atzkecheng_zuihouxgr = atzkecheng_zuihouxgr;
		}
			 	public String getAtzkecheng_zuihouxgr(){
	  		return atzkecheng_zuihouxgr;
	  	}
	    		 		public void setAtzkecheng_zuihouxgrid(Long atzkecheng_zuihouxgrid){
			this.atzkecheng_zuihouxgrid = atzkecheng_zuihouxgrid;
		}
			 	public Long getAtzkecheng_zuihouxgrid(){
	  		return atzkecheng_zuihouxgrid;
	  	}
	    		 		public void setAtzkecheng_zuihouxgrq(Date atzkecheng_zuihouxgrq){
			this.atzkecheng_zuihouxgrq = atzkecheng_zuihouxgrq;
		}
			 	public Date getAtzkecheng_zuihouxgrq(){
	  		return atzkecheng_zuihouxgrq;
	  	}
	    		 		public void setAtzkecheng_danjuzt(String atzkecheng_danjuzt){
			this.atzkecheng_danjuzt = atzkecheng_danjuzt;
		}
			 	public String getAtzkecheng_danjuzt(){
	  		return atzkecheng_danjuzt;
	  	}
	    	  	  public Long getAtzkecheng_id(){
  	  	return atzkecheng_id;
  	  }
  	  public void setAtzkecheng_id(Long atzkecheng_id){
  	  	this.atzkecheng_id = atzkecheng_id;
  	  }
	  public Long getId(){
	  	return getAtzkecheng_id();
	  }
