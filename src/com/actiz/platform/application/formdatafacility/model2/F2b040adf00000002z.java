...
* Author      :Actiz
* Build Time  :2017-12-06 17:14:34.62
*/
...
import java.sql.Blob;
	...
	public class F2b040adf00000002z{
						...
						private Object atzhetong_hetongmc;
							...
							private Object atzhetong_hetongje1;
								private Object atzhetong_suoshuhy;
										...
										private Object atzhetong_lixianglx;
	  		...
	  		public Object getAtzhetong_pingshenzt(){
	  			return atzhetong_pingshenzt;
  						...
  						public void setAtzhetong_lixianglx(Object atzhetong_lixianglx){
				this.atzhetong_lixianglx = atzhetong_lixianglx;
			}
			
	  		public Object getAtzhetong_lixianglx(){
  	...
  	public static F2b040adf00000002z init(DataContextHelper context) {
  		F2b040adf00000002z o = new F2b040adf00000002z();
									o.setAtzhetong_hetongmc(getValue(context,"atzhetong.hetongmc"));
										...
										o.setAtzhetong_hetongje1(getValue(context,"atzhetong.hetongje1"));
			  									o.setAtzhetong_suoshuhy(getValue(context,"atzhetong.suoshuhy"));
						  									...
						  									o.setAtzhetong_lixianglx(getValue(context,"atzhetong.lixianglx"));
