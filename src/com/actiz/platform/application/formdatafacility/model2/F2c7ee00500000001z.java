...
* Author      :Actiz
* Build Time  :2017-11-28 16:07:18.292
*/
...
public class F2c7ee00500000001z implements IAppEntityObject{
	private Long atzweixiujl_id;
			 		...
			 		private Long atzwuliaojcxx_id;
					 		...
					 		private Long atzweixiujl_actizversion;
					 			 		private Long atzweixiujl_scrwid;
					 		private String atzweixiujl_laiyuan = "";
					 		private Long atzweixiujl_wuliaoid;
					 		private String atzweixiujl_sn = "";
					 		private String atzweixiujl_weixiujl;
					 		private String atzweixiujl_weixiur = "";
					 		private Date atzweixiujl_weixiuksrq;
					 		private Date atzweixiujl_weixiujsrq;
					 		private String atzweixiujl_guzhangxx;
					 		private Long atzweixiujl_hetongid;
					 		private Date atzweixiujl_jihuawcrq;
					 		private String atzweixiujl_lurur = "";
					 		private Date atzweixiujl_lururq;
					 		private String atzweixiujl_zuihouxgr = "";
					 		private Date atzweixiujl_zuihouxgrq;
					 		private String atzweixiujl_fanghuidd = "";
					 		private String atzweixiujl_beizhu;
					 		private Date atzweixiujl_huichangsj;
					 		private String atzweixiujl_lianxidh = "";
			...
			this.atzwuliaojcxx_xsbmdanjuzt = atzwuliaojcxx_xsbmdanjuzt;
	  		...
	  		return atzwuliaojcxx_xsbmdanjuzt;
	    		 		...
	    		 		public void setAtzweixiujl_actizversion(Long atzweixiujl_actizversion){
			this.atzweixiujl_actizversion = atzweixiujl_actizversion;
		}
			 	public Long getAtzweixiujl_actizversion(){
	  		return atzweixiujl_actizversion;
	  	}
	    		   		 		public void setAtzweixiujl_scrwid(Long atzweixiujl_scrwid){
			this.atzweixiujl_scrwid = atzweixiujl_scrwid;
		}
			 	public Long getAtzweixiujl_scrwid(){
	  		return atzweixiujl_scrwid;
	  	}
	    		 		public void setAtzweixiujl_laiyuan(String atzweixiujl_laiyuan){
			this.atzweixiujl_laiyuan = atzweixiujl_laiyuan;
		}
			 	public String getAtzweixiujl_laiyuan(){
	  		return atzweixiujl_laiyuan;
	  	}
	    		 		public void setAtzweixiujl_wuliaoid(Long atzweixiujl_wuliaoid){
			this.atzweixiujl_wuliaoid = atzweixiujl_wuliaoid;
		}
			 	public Long getAtzweixiujl_wuliaoid(){
	  		return atzweixiujl_wuliaoid;
	  	}
	    		 		public void setAtzweixiujl_sn(String atzweixiujl_sn){
			this.atzweixiujl_sn = atzweixiujl_sn;
		}
			 	public String getAtzweixiujl_sn(){
	  		return atzweixiujl_sn;
	  	}
	    		 		public void setAtzweixiujl_weixiujl(String atzweixiujl_weixiujl){
			this.atzweixiujl_weixiujl = atzweixiujl_weixiujl;
		}
			 	public String getAtzweixiujl_weixiujl(){
	  		return atzweixiujl_weixiujl;
	  	}
	    		 		public void setAtzweixiujl_weixiur(String atzweixiujl_weixiur){
			this.atzweixiujl_weixiur = atzweixiujl_weixiur;
		}
			 	public String getAtzweixiujl_weixiur(){
	  		return atzweixiujl_weixiur;
	  	}
	    		 		public void setAtzweixiujl_weixiuksrq(Date atzweixiujl_weixiuksrq){
			this.atzweixiujl_weixiuksrq = atzweixiujl_weixiuksrq;
		}
			 	public Date getAtzweixiujl_weixiuksrq(){
	  		return atzweixiujl_weixiuksrq;
	  	}
	    		 		public void setAtzweixiujl_weixiujsrq(Date atzweixiujl_weixiujsrq){
			this.atzweixiujl_weixiujsrq = atzweixiujl_weixiujsrq;
		}
			 	public Date getAtzweixiujl_weixiujsrq(){
	  		return atzweixiujl_weixiujsrq;
	  	}
	    		 		public void setAtzweixiujl_guzhangxx(String atzweixiujl_guzhangxx){
			this.atzweixiujl_guzhangxx = atzweixiujl_guzhangxx;
		}
			 	public String getAtzweixiujl_guzhangxx(){
	  		return atzweixiujl_guzhangxx;
	  	}
	    		 		public void setAtzweixiujl_hetongid(Long atzweixiujl_hetongid){
			this.atzweixiujl_hetongid = atzweixiujl_hetongid;
		}
			 	public Long getAtzweixiujl_hetongid(){
	  		return atzweixiujl_hetongid;
	  	}
	    		 		public void setAtzweixiujl_jihuawcrq(Date atzweixiujl_jihuawcrq){
			this.atzweixiujl_jihuawcrq = atzweixiujl_jihuawcrq;
		}
			 	public Date getAtzweixiujl_jihuawcrq(){
	  		return atzweixiujl_jihuawcrq;
	  	}
	    		 		public void setAtzweixiujl_lurur(String atzweixiujl_lurur){
			this.atzweixiujl_lurur = atzweixiujl_lurur;
		}
			 	public String getAtzweixiujl_lurur(){
	  		return atzweixiujl_lurur;
	  	}
	    		 		public void setAtzweixiujl_lururq(Date atzweixiujl_lururq){
			this.atzweixiujl_lururq = atzweixiujl_lururq;
		}
			 	public Date getAtzweixiujl_lururq(){
	  		return atzweixiujl_lururq;
	  	}
	    		 		public void setAtzweixiujl_zuihouxgr(String atzweixiujl_zuihouxgr){
			this.atzweixiujl_zuihouxgr = atzweixiujl_zuihouxgr;
		}
			 	public String getAtzweixiujl_zuihouxgr(){
	  		return atzweixiujl_zuihouxgr;
	  	}
	    		 		public void setAtzweixiujl_zuihouxgrq(Date atzweixiujl_zuihouxgrq){
			this.atzweixiujl_zuihouxgrq = atzweixiujl_zuihouxgrq;
		}
			 	public Date getAtzweixiujl_zuihouxgrq(){
	  		return atzweixiujl_zuihouxgrq;
	  	}
	    		 		public void setAtzweixiujl_fanghuidd(String atzweixiujl_fanghuidd){
			this.atzweixiujl_fanghuidd = atzweixiujl_fanghuidd;
		}
			 	public String getAtzweixiujl_fanghuidd(){
	  		return atzweixiujl_fanghuidd;
	  	}
	    		 		public void setAtzweixiujl_beizhu(String atzweixiujl_beizhu){
			this.atzweixiujl_beizhu = atzweixiujl_beizhu;
		}
			 	public String getAtzweixiujl_beizhu(){
	  		return atzweixiujl_beizhu;
	  	}
	    		 		public void setAtzweixiujl_huichangsj(Date atzweixiujl_huichangsj){
			this.atzweixiujl_huichangsj = atzweixiujl_huichangsj;
		}
			 	public Date getAtzweixiujl_huichangsj(){
	  		return atzweixiujl_huichangsj;
	  	}
	    		 		public void setAtzweixiujl_lianxidh(String atzweixiujl_lianxidh){
			this.atzweixiujl_lianxidh = atzweixiujl_lianxidh;
		}
			 	public String getAtzweixiujl_lianxidh(){
	  		return atzweixiujl_lianxidh;
	  	}
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    	  	  ...
	    	  	  public Long getAtzweixiujl_id(){
  	  	return atzweixiujl_id;
  	  }
  	  public void setAtzweixiujl_id(Long atzweixiujl_id){
  	  	this.atzweixiujl_id = atzweixiujl_id;
  	  }
	  public Long getId(){
	  	return getAtzweixiujl_id();
	  }
