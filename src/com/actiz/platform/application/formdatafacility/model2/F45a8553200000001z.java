...
* Author      :Actiz
* Build Time  :2017-11-28 16:07:51.515
*/
...
import java.sql.Blob;
	...
	public class F45a8553200000001z{
			...
			private String atzchanpin_chanpinmc = "";
			...
			private String atzchanpin_chanpinx = "";
			private String atzchanpin_lurur = "";
			private Date atzchanpin_lururq;
			private String atzchanpin_zuihouxgr = "";
			private Date atzchanpin_zuihouxgrq;
  		...
  		public Long getAtzkehu_id(){
  			...
  			public void setAtzchanpin_id(Long atzchanpin_id){
			this.atzchanpin_id = atzchanpin_id;
		}
		
  		public Long getAtzchanpin_id(){
  		...
  		public String getAtzkehuxtxx_xitongmc(){
  			...
  			public void setAtzchanpin_chanpinmc(String atzchanpin_chanpinmc){
			this.atzchanpin_chanpinmc = atzchanpin_chanpinmc;
		}
		
  		public String getAtzchanpin_chanpinmc(){
  			return atzchanpin_chanpinmc;
  		}
  		...
  		public Long getAtzkehuxtxx_chanpinid(){
  			...
  			public void setAtzchanpin_chanpinx(String atzchanpin_chanpinx){
			this.atzchanpin_chanpinx = atzchanpin_chanpinx;
		}
		
  		public String getAtzchanpin_chanpinx(){
  			return atzchanpin_chanpinx;
  		}
  			public void setAtzchanpin_lurur(String atzchanpin_lurur){
			this.atzchanpin_lurur = atzchanpin_lurur;
		}
		
  		public String getAtzchanpin_lurur(){
  			return atzchanpin_lurur;
  		}
  			public void setAtzchanpin_lururq(Date atzchanpin_lururq){
			this.atzchanpin_lururq = atzchanpin_lururq;
		}
		
  		public Date getAtzchanpin_lururq(){
  			return atzchanpin_lururq;
  		}
  			public void setAtzchanpin_zuihouxgr(String atzchanpin_zuihouxgr){
			this.atzchanpin_zuihouxgr = atzchanpin_zuihouxgr;
		}
		
  		public String getAtzchanpin_zuihouxgr(){
  			return atzchanpin_zuihouxgr;
  		}
  			public void setAtzchanpin_zuihouxgrq(Date atzchanpin_zuihouxgrq){
			this.atzchanpin_zuihouxgrq = atzchanpin_zuihouxgrq;
		}
		
  		public Date getAtzchanpin_zuihouxgrq(){
  			return atzchanpin_zuihouxgrq;
  		}
  	  	  	public Long getId(){
	  	return getAtzweibaosbsqd_id();
	  }
