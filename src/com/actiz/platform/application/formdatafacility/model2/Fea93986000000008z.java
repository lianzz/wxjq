...
* Author      :Actiz
* Build Time  :2017-11-28 15:59:40.498
*/
...
public class Fea93986000000008z implements IAppEntityObject{
	private Long atzzichansq_id;
	
			 		private Long atzzichansq_actizversion;
					 			 		private Long atzzichansq_zichan;
					 		private Long atzzichansq_shenqingr;
					 		private Long atzzichansq_shenqingbm;
					 		private Date atzzichansq_shenqingrq;
					 		private String atzzichansq_lurur = "";
					 		private Date atzzichansq_lururq;
					 		private String atzzichansq_zuihouxgr = "";
					 		private Date atzzichansq_zuihouxgrq;
					 		private String atzzichansq_danjuzt = "";
					 		private String atzzichansq_shenqinglx = "";
					 		private Long atzzichansq_lururid;
					 		private Long atzzichansq_zuihouxgrid;
					 		private String atzzichansq_shengqingyy = "";
					 		private Date atzzichansq_jieyongzq;
					 		private String atzzichansq_beizhu;
					 		private String atzzichansq_xuqiuxx;
					 		...
					 		private Long atzgudingzc_id;
					 		private String atzgudingzc_shebeibh = "";
					 		private String atzgudingzc_erp = "";
					 		private String atzgudingzc_shebeimc = "";
					 		private String atzgudingzc_shebeilb = "";
					 		private String atzgudingzc_guige = "";
					 		private Double atzgudingzc_zichanyz = 0.0;
					 		private String atzgudingzc_shiyongdw = "";
					 		private Date atzgudingzc_shijirksj;
					 		private Long atzgudingzc_shiyongbm;
					 		private Long atzgudingzc_lingyongr;
					 		private Date atzgudingzc_lingyongrq;
					 		private String atzgudingzc_fangzhidd = "";
					 		private String atzgudingzc_zichanzt = "";
					 		private String atzgudingzc_yongtu = "";
					 		private Date atzgudingzc_youxiaoq;
					 		private String atzgudingzc_shegnchancj = "";
					 		private String atzgudingzc_chuchangbh = "";
					 		private Double atzgudingzc_jiandingzq = 0.0;
					 		private String atzgudingzc_jiandingdw = "";
					 		private String atzgudingzc_zhengshuh = "";
					 		private Date atzgudingzc_jdriqi;
					 		private String atzgudingzc_lurur = "";
					 		private Date atzgudingzc_lururq;
					 		private String atzgudingzc_zuihouxgr = "";
					 		private Date atzgudingzc_zuihouxgrq;
					 		private String atzgudingzc_zichanlx = "";
					 		private Long atzgudingzc_lururid;
					 		private Long atzgudingzc_zuihouxgrid;
					 		private Long atzgudingzc_jlglzcid;
					 		private String atzgudingzc_bxq = "";
					 		private Double atzgudingzc_jiliangfy = 0.0;
					 		private String atzgudingzc_peizhi;
					 		private String atzgudingzc_hetongh = "";
					 		private String atzgudingzc_shifousc = "";
					 		public void setAtzzichansq_actizversion(Long atzzichansq_actizversion){
			this.atzzichansq_actizversion = atzzichansq_actizversion;
		}
			 	public Long getAtzzichansq_actizversion(){
	  		return atzzichansq_actizversion;
	  	}
	    		   		 		public void setAtzzichansq_zichan(Long atzzichansq_zichan){
			this.atzzichansq_zichan = atzzichansq_zichan;
		}
			 	public Long getAtzzichansq_zichan(){
	  		return atzzichansq_zichan;
	  	}
	    		 		public void setAtzzichansq_shenqingr(Long atzzichansq_shenqingr){
			this.atzzichansq_shenqingr = atzzichansq_shenqingr;
		}
			 	public Long getAtzzichansq_shenqingr(){
	  		return atzzichansq_shenqingr;
	  	}
	    		 		public void setAtzzichansq_shenqingbm(Long atzzichansq_shenqingbm){
			this.atzzichansq_shenqingbm = atzzichansq_shenqingbm;
		}
			 	public Long getAtzzichansq_shenqingbm(){
	  		return atzzichansq_shenqingbm;
	  	}
	    		 		public void setAtzzichansq_shenqingrq(Date atzzichansq_shenqingrq){
			this.atzzichansq_shenqingrq = atzzichansq_shenqingrq;
		}
			 	public Date getAtzzichansq_shenqingrq(){
	  		return atzzichansq_shenqingrq;
	  	}
	    		 		public void setAtzzichansq_lurur(String atzzichansq_lurur){
			this.atzzichansq_lurur = atzzichansq_lurur;
		}
			 	public String getAtzzichansq_lurur(){
	  		return atzzichansq_lurur;
	  	}
	    		 		public void setAtzzichansq_lururq(Date atzzichansq_lururq){
			this.atzzichansq_lururq = atzzichansq_lururq;
		}
			 	public Date getAtzzichansq_lururq(){
	  		return atzzichansq_lururq;
	  	}
	    		 		public void setAtzzichansq_zuihouxgr(String atzzichansq_zuihouxgr){
			this.atzzichansq_zuihouxgr = atzzichansq_zuihouxgr;
		}
			 	public String getAtzzichansq_zuihouxgr(){
	  		return atzzichansq_zuihouxgr;
	  	}
	    		 		public void setAtzzichansq_zuihouxgrq(Date atzzichansq_zuihouxgrq){
			this.atzzichansq_zuihouxgrq = atzzichansq_zuihouxgrq;
		}
			 	public Date getAtzzichansq_zuihouxgrq(){
	  		return atzzichansq_zuihouxgrq;
	  	}
	    		 		public void setAtzzichansq_danjuzt(String atzzichansq_danjuzt){
			this.atzzichansq_danjuzt = atzzichansq_danjuzt;
		}
			 	public String getAtzzichansq_danjuzt(){
	  		return atzzichansq_danjuzt;
	  	}
	    		 		public void setAtzzichansq_shenqinglx(String atzzichansq_shenqinglx){
			this.atzzichansq_shenqinglx = atzzichansq_shenqinglx;
		}
			 	public String getAtzzichansq_shenqinglx(){
	  		return atzzichansq_shenqinglx;
	  	}
	    		 		public void setAtzzichansq_lururid(Long atzzichansq_lururid){
			this.atzzichansq_lururid = atzzichansq_lururid;
		}
			 	public Long getAtzzichansq_lururid(){
	  		return atzzichansq_lururid;
	  	}
	    		 		public void setAtzzichansq_zuihouxgrid(Long atzzichansq_zuihouxgrid){
			this.atzzichansq_zuihouxgrid = atzzichansq_zuihouxgrid;
		}
			 	public Long getAtzzichansq_zuihouxgrid(){
	  		return atzzichansq_zuihouxgrid;
	  	}
	    		 		public void setAtzzichansq_shengqingyy(String atzzichansq_shengqingyy){
			this.atzzichansq_shengqingyy = atzzichansq_shengqingyy;
		}
			 	public String getAtzzichansq_shengqingyy(){
	  		return atzzichansq_shengqingyy;
	  	}
	    		 		public void setAtzzichansq_jieyongzq(Date atzzichansq_jieyongzq){
			this.atzzichansq_jieyongzq = atzzichansq_jieyongzq;
		}
			 	public Date getAtzzichansq_jieyongzq(){
	  		return atzzichansq_jieyongzq;
	  	}
	    		 		public void setAtzzichansq_beizhu(String atzzichansq_beizhu){
			this.atzzichansq_beizhu = atzzichansq_beizhu;
		}
			 	public String getAtzzichansq_beizhu(){
	  		return atzzichansq_beizhu;
	  	}
	    		 		public void setAtzzichansq_xuqiuxx(String atzzichansq_xuqiuxx){
			this.atzzichansq_xuqiuxx = atzzichansq_xuqiuxx;
		}
			 	public String getAtzzichansq_xuqiuxx(){
	  		return atzzichansq_xuqiuxx;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    		 		...
	    		 		public void setAtzgudingzc_id(Long atzgudingzc_id){
			this.atzgudingzc_id = atzgudingzc_id;
		}
			 	public Long getAtzgudingzc_id(){
	  		return atzgudingzc_id;
	  	}
	    		 		public void setAtzgudingzc_shebeibh(String atzgudingzc_shebeibh){
			this.atzgudingzc_shebeibh = atzgudingzc_shebeibh;
		}
			 	public String getAtzgudingzc_shebeibh(){
	  		return atzgudingzc_shebeibh;
	  	}
	    		 		public void setAtzgudingzc_erp(String atzgudingzc_erp){
			this.atzgudingzc_erp = atzgudingzc_erp;
		}
			 	public String getAtzgudingzc_erp(){
	  		return atzgudingzc_erp;
	  	}
	    		 		public void setAtzgudingzc_shebeimc(String atzgudingzc_shebeimc){
			this.atzgudingzc_shebeimc = atzgudingzc_shebeimc;
		}
			 	public String getAtzgudingzc_shebeimc(){
	  		return atzgudingzc_shebeimc;
	  	}
	    		 		public void setAtzgudingzc_shebeilb(String atzgudingzc_shebeilb){
			this.atzgudingzc_shebeilb = atzgudingzc_shebeilb;
		}
			 	public String getAtzgudingzc_shebeilb(){
	  		return atzgudingzc_shebeilb;
	  	}
	    		 		public void setAtzgudingzc_guige(String atzgudingzc_guige){
			this.atzgudingzc_guige = atzgudingzc_guige;
		}
			 	public String getAtzgudingzc_guige(){
	  		return atzgudingzc_guige;
	  	}
	    		 		public void setAtzgudingzc_zichanyz(Double atzgudingzc_zichanyz){
			this.atzgudingzc_zichanyz = atzgudingzc_zichanyz;
		}
			 	public Double getAtzgudingzc_zichanyz(){
	  		return atzgudingzc_zichanyz;
	  	}
	    		 		public void setAtzgudingzc_shiyongdw(String atzgudingzc_shiyongdw){
			this.atzgudingzc_shiyongdw = atzgudingzc_shiyongdw;
		}
			 	public String getAtzgudingzc_shiyongdw(){
	  		return atzgudingzc_shiyongdw;
	  	}
	    		 		public void setAtzgudingzc_shijirksj(Date atzgudingzc_shijirksj){
			this.atzgudingzc_shijirksj = atzgudingzc_shijirksj;
		}
			 	public Date getAtzgudingzc_shijirksj(){
	  		return atzgudingzc_shijirksj;
	  	}
	    		 		public void setAtzgudingzc_shiyongbm(Long atzgudingzc_shiyongbm){
			this.atzgudingzc_shiyongbm = atzgudingzc_shiyongbm;
		}
			 	public Long getAtzgudingzc_shiyongbm(){
	  		return atzgudingzc_shiyongbm;
	  	}
	    		 		public void setAtzgudingzc_lingyongr(Long atzgudingzc_lingyongr){
			this.atzgudingzc_lingyongr = atzgudingzc_lingyongr;
		}
			 	public Long getAtzgudingzc_lingyongr(){
	  		return atzgudingzc_lingyongr;
	  	}
	    		 		public void setAtzgudingzc_lingyongrq(Date atzgudingzc_lingyongrq){
			this.atzgudingzc_lingyongrq = atzgudingzc_lingyongrq;
		}
			 	public Date getAtzgudingzc_lingyongrq(){
	  		return atzgudingzc_lingyongrq;
	  	}
	    		 		public void setAtzgudingzc_fangzhidd(String atzgudingzc_fangzhidd){
			this.atzgudingzc_fangzhidd = atzgudingzc_fangzhidd;
		}
			 	public String getAtzgudingzc_fangzhidd(){
	  		return atzgudingzc_fangzhidd;
	  	}
	    		 		public void setAtzgudingzc_zichanzt(String atzgudingzc_zichanzt){
			this.atzgudingzc_zichanzt = atzgudingzc_zichanzt;
		}
			 	public String getAtzgudingzc_zichanzt(){
	  		return atzgudingzc_zichanzt;
	  	}
	    		 		public void setAtzgudingzc_yongtu(String atzgudingzc_yongtu){
			this.atzgudingzc_yongtu = atzgudingzc_yongtu;
		}
			 	public String getAtzgudingzc_yongtu(){
	  		return atzgudingzc_yongtu;
	  	}
	    		 		public void setAtzgudingzc_youxiaoq(Date atzgudingzc_youxiaoq){
			this.atzgudingzc_youxiaoq = atzgudingzc_youxiaoq;
		}
			 	public Date getAtzgudingzc_youxiaoq(){
	  		return atzgudingzc_youxiaoq;
	  	}
	    		 		public void setAtzgudingzc_shegnchancj(String atzgudingzc_shegnchancj){
			this.atzgudingzc_shegnchancj = atzgudingzc_shegnchancj;
		}
			 	public String getAtzgudingzc_shegnchancj(){
	  		return atzgudingzc_shegnchancj;
	  	}
	    		 		public void setAtzgudingzc_chuchangbh(String atzgudingzc_chuchangbh){
			this.atzgudingzc_chuchangbh = atzgudingzc_chuchangbh;
		}
			 	public String getAtzgudingzc_chuchangbh(){
	  		return atzgudingzc_chuchangbh;
	  	}
	    		 		public void setAtzgudingzc_jiandingzq(Double atzgudingzc_jiandingzq){
			this.atzgudingzc_jiandingzq = atzgudingzc_jiandingzq;
		}
			 	public Double getAtzgudingzc_jiandingzq(){
	  		return atzgudingzc_jiandingzq;
	  	}
	    		 		public void setAtzgudingzc_jiandingdw(String atzgudingzc_jiandingdw){
			this.atzgudingzc_jiandingdw = atzgudingzc_jiandingdw;
		}
			 	public String getAtzgudingzc_jiandingdw(){
	  		return atzgudingzc_jiandingdw;
	  	}
	    		 		public void setAtzgudingzc_zhengshuh(String atzgudingzc_zhengshuh){
			this.atzgudingzc_zhengshuh = atzgudingzc_zhengshuh;
		}
			 	public String getAtzgudingzc_zhengshuh(){
	  		return atzgudingzc_zhengshuh;
	  	}
	    		 		public void setAtzgudingzc_jdriqi(Date atzgudingzc_jdriqi){
			this.atzgudingzc_jdriqi = atzgudingzc_jdriqi;
		}
			 	public Date getAtzgudingzc_jdriqi(){
	  		return atzgudingzc_jdriqi;
	  	}
	    		 		public void setAtzgudingzc_lurur(String atzgudingzc_lurur){
			this.atzgudingzc_lurur = atzgudingzc_lurur;
		}
			 	public String getAtzgudingzc_lurur(){
	  		return atzgudingzc_lurur;
	  	}
	    		 		public void setAtzgudingzc_lururq(Date atzgudingzc_lururq){
			this.atzgudingzc_lururq = atzgudingzc_lururq;
		}
			 	public Date getAtzgudingzc_lururq(){
	  		return atzgudingzc_lururq;
	  	}
	    		 		public void setAtzgudingzc_zuihouxgr(String atzgudingzc_zuihouxgr){
			this.atzgudingzc_zuihouxgr = atzgudingzc_zuihouxgr;
		}
			 	public String getAtzgudingzc_zuihouxgr(){
	  		return atzgudingzc_zuihouxgr;
	  	}
	    		 		public void setAtzgudingzc_zuihouxgrq(Date atzgudingzc_zuihouxgrq){
			this.atzgudingzc_zuihouxgrq = atzgudingzc_zuihouxgrq;
		}
			 	public Date getAtzgudingzc_zuihouxgrq(){
	  		return atzgudingzc_zuihouxgrq;
	  	}
	    		 		public void setAtzgudingzc_zichanlx(String atzgudingzc_zichanlx){
			this.atzgudingzc_zichanlx = atzgudingzc_zichanlx;
		}
			 	public String getAtzgudingzc_zichanlx(){
	  		return atzgudingzc_zichanlx;
	  	}
	    		 		public void setAtzgudingzc_lururid(Long atzgudingzc_lururid){
			this.atzgudingzc_lururid = atzgudingzc_lururid;
		}
			 	public Long getAtzgudingzc_lururid(){
	  		return atzgudingzc_lururid;
	  	}
	    		 		public void setAtzgudingzc_zuihouxgrid(Long atzgudingzc_zuihouxgrid){
			this.atzgudingzc_zuihouxgrid = atzgudingzc_zuihouxgrid;
		}
			 	public Long getAtzgudingzc_zuihouxgrid(){
	  		return atzgudingzc_zuihouxgrid;
	  	}
	    		 		public void setAtzgudingzc_jlglzcid(Long atzgudingzc_jlglzcid){
			this.atzgudingzc_jlglzcid = atzgudingzc_jlglzcid;
		}
			 	public Long getAtzgudingzc_jlglzcid(){
	  		return atzgudingzc_jlglzcid;
	  	}
	    		 		public void setAtzgudingzc_bxq(String atzgudingzc_bxq){
			this.atzgudingzc_bxq = atzgudingzc_bxq;
		}
			 	public String getAtzgudingzc_bxq(){
	  		return atzgudingzc_bxq;
	  	}
	    		 		public void setAtzgudingzc_jiliangfy(Double atzgudingzc_jiliangfy){
			this.atzgudingzc_jiliangfy = atzgudingzc_jiliangfy;
		}
			 	public Double getAtzgudingzc_jiliangfy(){
	  		return atzgudingzc_jiliangfy;
	  	}
	    		 		public void setAtzgudingzc_peizhi(String atzgudingzc_peizhi){
			this.atzgudingzc_peizhi = atzgudingzc_peizhi;
		}
			 	public String getAtzgudingzc_peizhi(){
	  		return atzgudingzc_peizhi;
	  	}
	    		 		public void setAtzgudingzc_hetongh(String atzgudingzc_hetongh){
			this.atzgudingzc_hetongh = atzgudingzc_hetongh;
		}
			 	public String getAtzgudingzc_hetongh(){
	  		return atzgudingzc_hetongh;
	  	}
	    		 		public void setAtzgudingzc_shifousc(String atzgudingzc_shifousc){
			this.atzgudingzc_shifousc = atzgudingzc_shifousc;
		}
			 	public String getAtzgudingzc_shifousc(){
	  		return atzgudingzc_shifousc;
	  	}
	    	  	  public Long getAtzzichansq_id(){
  	  	return atzzichansq_id;
  	  }
  	  public void setAtzzichansq_id(Long atzzichansq_id){
  	  	this.atzzichansq_id = atzzichansq_id;
  	  }
	  public Long getId(){
	  	return getAtzzichansq_id();
	  }
