...
* Author      :Actiz
* Build Time  :2017-11-28 16:07:12.847
*/
...
public class F58f35a2000000003z implements IAppEntityObject{
	private Long atzgongzuorz_id;
			 		...
			 		private Long atzkehuxtxx_id;
					 		...
					 		private Long atzgongzuorz_actizversion;
					 			 		private String atzgongzuorz_zhuti = "";
					 		private String atzgongzuorz_yuangongxm = "";
					 		private String atzgongzuorz_rizhilx = "";
					 		private Long atzgongzuorz_hetongbh;
					 		private Long atzgongzuorz_xitongmc;
					 		private Long atzgongzuorz_xmpqdid;
					 		private String atzgongzuorz_gongzuodd = "";
					 		private String atzgongzuorz_fuzer = "";
					 		private String atzgongzuorz_lianxifs = "";
					 		private String atzgongzuorz_xianchangry = "";
					 		private Date atzgongzuorz_tianbaorq;
					 		private String atzgongzuorz_dangriqkms;
					 		private String atzgongzuorz_dangriwtcl;
					 		private String atzgongzuorz_yiqianwtcl;
					 		private String atzgongzuorz_mingrigzjh;
					 		private String atzgongzuorz_lurur = "";
					 		private Date atzgongzuorz_lururq;
					 		private String atzgongzuorz_zuihouxgr = "";
					 		private Date atzgongzuorz_jhkssj;
					 		private Date atzgongzuorz_zuihouxgrq;
					 		private Date atzgongzuorz_jhwcsj;
			...
			this.atzkehuxtxx_chanpinid = atzkehuxtxx_chanpinid;
	  		...
	  		return atzkehuxtxx_chanpinid;
	    		 		...
	    		 		public void setAtzgongzuorz_actizversion(Long atzgongzuorz_actizversion){
			this.atzgongzuorz_actizversion = atzgongzuorz_actizversion;
		}
			 	public Long getAtzgongzuorz_actizversion(){
	  		return atzgongzuorz_actizversion;
	  	}
	    		   		 		public void setAtzgongzuorz_zhuti(String atzgongzuorz_zhuti){
			this.atzgongzuorz_zhuti = atzgongzuorz_zhuti;
		}
			 	public String getAtzgongzuorz_zhuti(){
	  		return atzgongzuorz_zhuti;
	  	}
	    		 		public void setAtzgongzuorz_yuangongxm(String atzgongzuorz_yuangongxm){
			this.atzgongzuorz_yuangongxm = atzgongzuorz_yuangongxm;
		}
			 	public String getAtzgongzuorz_yuangongxm(){
	  		return atzgongzuorz_yuangongxm;
	  	}
	    		 		public void setAtzgongzuorz_rizhilx(String atzgongzuorz_rizhilx){
			this.atzgongzuorz_rizhilx = atzgongzuorz_rizhilx;
		}
			 	public String getAtzgongzuorz_rizhilx(){
	  		return atzgongzuorz_rizhilx;
	  	}
	    		 		public void setAtzgongzuorz_hetongbh(Long atzgongzuorz_hetongbh){
			this.atzgongzuorz_hetongbh = atzgongzuorz_hetongbh;
		}
			 	public Long getAtzgongzuorz_hetongbh(){
	  		return atzgongzuorz_hetongbh;
	  	}
	    		 		public void setAtzgongzuorz_xitongmc(Long atzgongzuorz_xitongmc){
			this.atzgongzuorz_xitongmc = atzgongzuorz_xitongmc;
		}
			 	public Long getAtzgongzuorz_xitongmc(){
	  		return atzgongzuorz_xitongmc;
	  	}
	    		 		public void setAtzgongzuorz_xmpqdid(Long atzgongzuorz_xmpqdid){
			this.atzgongzuorz_xmpqdid = atzgongzuorz_xmpqdid;
		}
			 	public Long getAtzgongzuorz_xmpqdid(){
	  		return atzgongzuorz_xmpqdid;
	  	}
	    		 		public void setAtzgongzuorz_gongzuodd(String atzgongzuorz_gongzuodd){
			this.atzgongzuorz_gongzuodd = atzgongzuorz_gongzuodd;
		}
			 	public String getAtzgongzuorz_gongzuodd(){
	  		return atzgongzuorz_gongzuodd;
	  	}
	    		 		public void setAtzgongzuorz_fuzer(String atzgongzuorz_fuzer){
			this.atzgongzuorz_fuzer = atzgongzuorz_fuzer;
		}
			 	public String getAtzgongzuorz_fuzer(){
	  		return atzgongzuorz_fuzer;
	  	}
	    		 		public void setAtzgongzuorz_lianxifs(String atzgongzuorz_lianxifs){
			this.atzgongzuorz_lianxifs = atzgongzuorz_lianxifs;
		}
			 	public String getAtzgongzuorz_lianxifs(){
	  		return atzgongzuorz_lianxifs;
	  	}
	    		 		public void setAtzgongzuorz_xianchangry(String atzgongzuorz_xianchangry){
			this.atzgongzuorz_xianchangry = atzgongzuorz_xianchangry;
		}
			 	public String getAtzgongzuorz_xianchangry(){
	  		return atzgongzuorz_xianchangry;
	  	}
	    		 		public void setAtzgongzuorz_tianbaorq(Date atzgongzuorz_tianbaorq){
			this.atzgongzuorz_tianbaorq = atzgongzuorz_tianbaorq;
		}
			 	public Date getAtzgongzuorz_tianbaorq(){
	  		return atzgongzuorz_tianbaorq;
	  	}
	    		 		public void setAtzgongzuorz_dangriqkms(String atzgongzuorz_dangriqkms){
			this.atzgongzuorz_dangriqkms = atzgongzuorz_dangriqkms;
		}
			 	public String getAtzgongzuorz_dangriqkms(){
	  		return atzgongzuorz_dangriqkms;
	  	}
	    		 		public void setAtzgongzuorz_dangriwtcl(String atzgongzuorz_dangriwtcl){
			this.atzgongzuorz_dangriwtcl = atzgongzuorz_dangriwtcl;
		}
			 	public String getAtzgongzuorz_dangriwtcl(){
	  		return atzgongzuorz_dangriwtcl;
	  	}
	    		 		public void setAtzgongzuorz_yiqianwtcl(String atzgongzuorz_yiqianwtcl){
			this.atzgongzuorz_yiqianwtcl = atzgongzuorz_yiqianwtcl;
		}
			 	public String getAtzgongzuorz_yiqianwtcl(){
	  		return atzgongzuorz_yiqianwtcl;
	  	}
	    		 		public void setAtzgongzuorz_mingrigzjh(String atzgongzuorz_mingrigzjh){
			this.atzgongzuorz_mingrigzjh = atzgongzuorz_mingrigzjh;
		}
			 	public String getAtzgongzuorz_mingrigzjh(){
	  		return atzgongzuorz_mingrigzjh;
	  	}
	    		 		public void setAtzgongzuorz_lurur(String atzgongzuorz_lurur){
			this.atzgongzuorz_lurur = atzgongzuorz_lurur;
		}
			 	public String getAtzgongzuorz_lurur(){
	  		return atzgongzuorz_lurur;
	  	}
	    		 		public void setAtzgongzuorz_lururq(Date atzgongzuorz_lururq){
			this.atzgongzuorz_lururq = atzgongzuorz_lururq;
		}
			 	public Date getAtzgongzuorz_lururq(){
	  		return atzgongzuorz_lururq;
	  	}
	    		 		public void setAtzgongzuorz_zuihouxgr(String atzgongzuorz_zuihouxgr){
			this.atzgongzuorz_zuihouxgr = atzgongzuorz_zuihouxgr;
		}
			 	public String getAtzgongzuorz_zuihouxgr(){
	  		return atzgongzuorz_zuihouxgr;
	  	}
	    		 		public void setAtzgongzuorz_jhkssj(Date atzgongzuorz_jhkssj){
			this.atzgongzuorz_jhkssj = atzgongzuorz_jhkssj;
		}
			 	public Date getAtzgongzuorz_jhkssj(){
	  		return atzgongzuorz_jhkssj;
	  	}
	    		 		public void setAtzgongzuorz_zuihouxgrq(Date atzgongzuorz_zuihouxgrq){
			this.atzgongzuorz_zuihouxgrq = atzgongzuorz_zuihouxgrq;
		}
			 	public Date getAtzgongzuorz_zuihouxgrq(){
	  		return atzgongzuorz_zuihouxgrq;
	  	}
	    		 		public void setAtzgongzuorz_jhwcsj(Date atzgongzuorz_jhwcsj){
			this.atzgongzuorz_jhwcsj = atzgongzuorz_jhwcsj;
		}
			 	public Date getAtzgongzuorz_jhwcsj(){
	  		return atzgongzuorz_jhwcsj;
	  	}
			...
			this.atzxiangmupqd_xiafar = atzxiangmupqd_xiafar;
	  		...
	  		return atzxiangmupqd_xiafar;
	    	  	  ...
	    	  	  public Long getAtzgongzuorz_id(){
  	  	return atzgongzuorz_id;
  	  }
  	  public void setAtzgongzuorz_id(Long atzgongzuorz_id){
  	  	this.atzgongzuorz_id = atzgongzuorz_id;
  	  }
	  public Long getId(){
	  	return getAtzgongzuorz_id();
	  }
