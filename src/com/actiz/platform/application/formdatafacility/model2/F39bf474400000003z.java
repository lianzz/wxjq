...
* Author      :Actiz
* Build Time  :2017-11-28 16:11:01.925
*/
...
public class F39bf474400000003z implements IAppEntityObject{
	private Long atzhetongbg_id;
			 		...
			 		private Long atzhetong_id;
					 		...
					 		private Long atzhetongbg_actizversion;
					 			 		private String atzhetongbg_bianhao = "";
					 		private String atzhetongbg_biangenglx = "";
					 		private String atzhetongbg_biangengfj;
					 		private Long atzhetongbg_lururid;
					 		private String atzhetongbg_lurur = "";
					 		private Date atzhetongbg_lururq;
					 		private Long atzhetongbg_zuihouxgrid;
					 		private String atzhetongbg_zuihouxgr = "";
					 		private Date atzhetongbg_zuihouxgrq;
					 		private String atzhetongbg_biangengzd = "";
					 		private String atzhetongbg_biangengq = "";
					 		private String atzhetongbg_biangengh = "";
					 		private String atzhetongbg_danjuzt = "";
					 		private Long atzhetongbg_hetongid;
					 		private String atzhetongbg_biangengms;
					 		private String atzhetongbg_shzt = "";
					 		private String atzhetongbg_shyj;
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    		 		...
	    		 		public void setAtzhetongbg_actizversion(Long atzhetongbg_actizversion){
			this.atzhetongbg_actizversion = atzhetongbg_actizversion;
		}
			 	public Long getAtzhetongbg_actizversion(){
	  		return atzhetongbg_actizversion;
	  	}
	    		   		 		public void setAtzhetongbg_bianhao(String atzhetongbg_bianhao){
			this.atzhetongbg_bianhao = atzhetongbg_bianhao;
		}
			 	public String getAtzhetongbg_bianhao(){
	  		return atzhetongbg_bianhao;
	  	}
	    		 		public void setAtzhetongbg_biangenglx(String atzhetongbg_biangenglx){
			this.atzhetongbg_biangenglx = atzhetongbg_biangenglx;
		}
			 	public String getAtzhetongbg_biangenglx(){
	  		return atzhetongbg_biangenglx;
	  	}
	    		 		public void setAtzhetongbg_biangengfj(String atzhetongbg_biangengfj){
			this.atzhetongbg_biangengfj = atzhetongbg_biangengfj;
		}
			 	public String getAtzhetongbg_biangengfj(){
	  		return atzhetongbg_biangengfj;
	  	}
	    		 		public void setAtzhetongbg_lururid(Long atzhetongbg_lururid){
			this.atzhetongbg_lururid = atzhetongbg_lururid;
		}
			 	public Long getAtzhetongbg_lururid(){
	  		return atzhetongbg_lururid;
	  	}
	    		 		public void setAtzhetongbg_lurur(String atzhetongbg_lurur){
			this.atzhetongbg_lurur = atzhetongbg_lurur;
		}
			 	public String getAtzhetongbg_lurur(){
	  		return atzhetongbg_lurur;
	  	}
	    		 		public void setAtzhetongbg_lururq(Date atzhetongbg_lururq){
			this.atzhetongbg_lururq = atzhetongbg_lururq;
		}
			 	public Date getAtzhetongbg_lururq(){
	  		return atzhetongbg_lururq;
	  	}
	    		 		public void setAtzhetongbg_zuihouxgrid(Long atzhetongbg_zuihouxgrid){
			this.atzhetongbg_zuihouxgrid = atzhetongbg_zuihouxgrid;
		}
			 	public Long getAtzhetongbg_zuihouxgrid(){
	  		return atzhetongbg_zuihouxgrid;
	  	}
	    		 		public void setAtzhetongbg_zuihouxgr(String atzhetongbg_zuihouxgr){
			this.atzhetongbg_zuihouxgr = atzhetongbg_zuihouxgr;
		}
			 	public String getAtzhetongbg_zuihouxgr(){
	  		return atzhetongbg_zuihouxgr;
	  	}
	    		 		public void setAtzhetongbg_zuihouxgrq(Date atzhetongbg_zuihouxgrq){
			this.atzhetongbg_zuihouxgrq = atzhetongbg_zuihouxgrq;
		}
			 	public Date getAtzhetongbg_zuihouxgrq(){
	  		return atzhetongbg_zuihouxgrq;
	  	}
	    		 		public void setAtzhetongbg_biangengzd(String atzhetongbg_biangengzd){
			this.atzhetongbg_biangengzd = atzhetongbg_biangengzd;
		}
			 	public String getAtzhetongbg_biangengzd(){
	  		return atzhetongbg_biangengzd;
	  	}
	    		 		public void setAtzhetongbg_biangengq(String atzhetongbg_biangengq){
			this.atzhetongbg_biangengq = atzhetongbg_biangengq;
		}
			 	public String getAtzhetongbg_biangengq(){
	  		return atzhetongbg_biangengq;
	  	}
	    		 		public void setAtzhetongbg_biangengh(String atzhetongbg_biangengh){
			this.atzhetongbg_biangengh = atzhetongbg_biangengh;
		}
			 	public String getAtzhetongbg_biangengh(){
	  		return atzhetongbg_biangengh;
	  	}
	    		 		public void setAtzhetongbg_danjuzt(String atzhetongbg_danjuzt){
			this.atzhetongbg_danjuzt = atzhetongbg_danjuzt;
		}
			 	public String getAtzhetongbg_danjuzt(){
	  		return atzhetongbg_danjuzt;
	  	}
	    		 		public void setAtzhetongbg_hetongid(Long atzhetongbg_hetongid){
			this.atzhetongbg_hetongid = atzhetongbg_hetongid;
		}
			 	public Long getAtzhetongbg_hetongid(){
	  		return atzhetongbg_hetongid;
	  	}
	    		 		public void setAtzhetongbg_biangengms(String atzhetongbg_biangengms){
			this.atzhetongbg_biangengms = atzhetongbg_biangengms;
		}
			 	public String getAtzhetongbg_biangengms(){
	  		return atzhetongbg_biangengms;
	  	}
	    		 		public void setAtzhetongbg_shzt(String atzhetongbg_shzt){
			this.atzhetongbg_shzt = atzhetongbg_shzt;
		}
			 	public String getAtzhetongbg_shzt(){
	  		return atzhetongbg_shzt;
	  	}
	    		 		public void setAtzhetongbg_shyj(String atzhetongbg_shyj){
			this.atzhetongbg_shyj = atzhetongbg_shyj;
		}
			 	public String getAtzhetongbg_shyj(){
	  		return atzhetongbg_shyj;
	  	}
	    	  	  public Long getAtzhetongbg_id(){
  	  	return atzhetongbg_id;
  	  }
  	  public void setAtzhetongbg_id(Long atzhetongbg_id){
  	  	this.atzhetongbg_id = atzhetongbg_id;
  	  }
	  public Long getId(){
	  	return getAtzhetongbg_id();
	  }
