...
* Author      :Actiz
* Build Time  :2017-11-28 16:13:23.129
*/
...
public class F4ce8a40500000001z implements IAppEntityObject{
	private Long atzbenzhouzjmx_id;
			 		...
			 		private Long atzdepartment_id;
					 		...
					 		private Long atzbenzhouzjmx_actizversion;
					 			 		private Long atzbenzhouzjmx_atzzhouzjjhid;
					 		private String atzbenzhouzjmx_xiangmumc = "";
					 		private String atzbenzhouzjmx_zongjienr;
					 		private String atzbenzhouzjmx_shangxiazzt = "";
					 		private Long atzbenzhouzjmx_huizongid;
					 		private Long atzbenzhouzjmx_bumen;
					 		private String atzbenzhouzjmx_shifousy = "";
			...
			this.atzdepartment_gczgid = atzdepartment_gczgid;
	  		...
	  		return atzdepartment_gczgid;
	    		 		...
	    		 		public void setAtzbenzhouzjmx_actizversion(Long atzbenzhouzjmx_actizversion){
			this.atzbenzhouzjmx_actizversion = atzbenzhouzjmx_actizversion;
		}
			 	public Long getAtzbenzhouzjmx_actizversion(){
	  		return atzbenzhouzjmx_actizversion;
	  	}
	    		   		 		public void setAtzbenzhouzjmx_atzzhouzjjhid(Long atzbenzhouzjmx_atzzhouzjjhid){
			this.atzbenzhouzjmx_atzzhouzjjhid = atzbenzhouzjmx_atzzhouzjjhid;
		}
			 	public Long getAtzbenzhouzjmx_atzzhouzjjhid(){
	  		return atzbenzhouzjmx_atzzhouzjjhid;
	  	}
	    		 		public void setAtzbenzhouzjmx_xiangmumc(String atzbenzhouzjmx_xiangmumc){
			this.atzbenzhouzjmx_xiangmumc = atzbenzhouzjmx_xiangmumc;
		}
			 	public String getAtzbenzhouzjmx_xiangmumc(){
	  		return atzbenzhouzjmx_xiangmumc;
	  	}
	    		 		public void setAtzbenzhouzjmx_zongjienr(String atzbenzhouzjmx_zongjienr){
			this.atzbenzhouzjmx_zongjienr = atzbenzhouzjmx_zongjienr;
		}
			 	public String getAtzbenzhouzjmx_zongjienr(){
	  		return atzbenzhouzjmx_zongjienr;
	  	}
	    		 		public void setAtzbenzhouzjmx_shangxiazzt(String atzbenzhouzjmx_shangxiazzt){
			this.atzbenzhouzjmx_shangxiazzt = atzbenzhouzjmx_shangxiazzt;
		}
			 	public String getAtzbenzhouzjmx_shangxiazzt(){
	  		return atzbenzhouzjmx_shangxiazzt;
	  	}
	    		 		public void setAtzbenzhouzjmx_huizongid(Long atzbenzhouzjmx_huizongid){
			this.atzbenzhouzjmx_huizongid = atzbenzhouzjmx_huizongid;
		}
			 	public Long getAtzbenzhouzjmx_huizongid(){
	  		return atzbenzhouzjmx_huizongid;
	  	}
	    		 		public void setAtzbenzhouzjmx_bumen(Long atzbenzhouzjmx_bumen){
			this.atzbenzhouzjmx_bumen = atzbenzhouzjmx_bumen;
		}
			 	public Long getAtzbenzhouzjmx_bumen(){
	  		return atzbenzhouzjmx_bumen;
	  	}
	    		 		public void setAtzbenzhouzjmx_shifousy(String atzbenzhouzjmx_shifousy){
			this.atzbenzhouzjmx_shifousy = atzbenzhouzjmx_shifousy;
		}
			 	public String getAtzbenzhouzjmx_shifousy(){
	  		return atzbenzhouzjmx_shifousy;
	  	}
	    	  	  public Long getAtzbenzhouzjmx_id(){
  	  	return atzbenzhouzjmx_id;
  	  }
  	  public void setAtzbenzhouzjmx_id(Long atzbenzhouzjmx_id){
  	  	this.atzbenzhouzjmx_id = atzbenzhouzjmx_id;
  	  }
	  public Long getId(){
	  	return getAtzbenzhouzjmx_id();
	  }
