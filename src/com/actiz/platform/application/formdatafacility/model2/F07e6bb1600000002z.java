...
* Author      :Actiz
* Build Time  :2017-11-28 16:10:24.73
*/
...
public class F07e6bb1600000002z implements IAppEntityObject{
	private Long atzhetongtk_id;
			 		...
			 		private Long atzhetong_id;
					 		...
					 		private Long atzhetongtk_actizversion;
					 			 		private String atzhetongtk_bianhao = "";
					 		private Long atzhetongtk_hetongid;
					 		private String atzhetongtk_beizhu;
					 		private String atzhetongtk_danjuzt = "1";
					 		private String atzhetongtk_shzt = "";
					 		private String atzhetongtk_shyj;
					 		private Long atzhetongtk_lururid;
					 		private String atzhetongtk_lurur = "";
					 		private Date atzhetongtk_lururq;
					 		private Long atzhetongtk_zuihouxgrid;
					 		private String atzhetongtk_zuihouxgr = "";
					 		private Timestamp atzhetongtk_zuihouxgrq;
					 		private String atzhetongtk_tkyy = "";
					 		private Date atzhetongtk_yjfhsj;
					 		private String atzhetongtk_glfahuotzd = "";
			...
			this.atzhetong_jiesulc = atzhetong_jiesulc;
	  		...
	  		return atzhetong_jiesulc;
	    		 		...
	    		 		public void setAtzhetongtk_actizversion(Long atzhetongtk_actizversion){
			this.atzhetongtk_actizversion = atzhetongtk_actizversion;
		}
			 	public Long getAtzhetongtk_actizversion(){
	  		return atzhetongtk_actizversion;
	  	}
	    		   		 		public void setAtzhetongtk_bianhao(String atzhetongtk_bianhao){
			this.atzhetongtk_bianhao = atzhetongtk_bianhao;
		}
			 	public String getAtzhetongtk_bianhao(){
	  		return atzhetongtk_bianhao;
	  	}
	    		 		public void setAtzhetongtk_hetongid(Long atzhetongtk_hetongid){
			this.atzhetongtk_hetongid = atzhetongtk_hetongid;
		}
			 	public Long getAtzhetongtk_hetongid(){
	  		return atzhetongtk_hetongid;
	  	}
	    		 		public void setAtzhetongtk_beizhu(String atzhetongtk_beizhu){
			this.atzhetongtk_beizhu = atzhetongtk_beizhu;
		}
			 	public String getAtzhetongtk_beizhu(){
	  		return atzhetongtk_beizhu;
	  	}
	    		 		public void setAtzhetongtk_danjuzt(String atzhetongtk_danjuzt){
			this.atzhetongtk_danjuzt = atzhetongtk_danjuzt;
		}
			 	public String getAtzhetongtk_danjuzt(){
	  		return atzhetongtk_danjuzt;
	  	}
	    		 		public void setAtzhetongtk_shzt(String atzhetongtk_shzt){
			this.atzhetongtk_shzt = atzhetongtk_shzt;
		}
			 	public String getAtzhetongtk_shzt(){
	  		return atzhetongtk_shzt;
	  	}
	    		 		public void setAtzhetongtk_shyj(String atzhetongtk_shyj){
			this.atzhetongtk_shyj = atzhetongtk_shyj;
		}
			 	public String getAtzhetongtk_shyj(){
	  		return atzhetongtk_shyj;
	  	}
	    		 		public void setAtzhetongtk_lururid(Long atzhetongtk_lururid){
			this.atzhetongtk_lururid = atzhetongtk_lururid;
		}
			 	public Long getAtzhetongtk_lururid(){
	  		return atzhetongtk_lururid;
	  	}
	    		 		public void setAtzhetongtk_lurur(String atzhetongtk_lurur){
			this.atzhetongtk_lurur = atzhetongtk_lurur;
		}
			 	public String getAtzhetongtk_lurur(){
	  		return atzhetongtk_lurur;
	  	}
	    		 		public void setAtzhetongtk_lururq(Date atzhetongtk_lururq){
			this.atzhetongtk_lururq = atzhetongtk_lururq;
		}
			 	public Date getAtzhetongtk_lururq(){
	  		return atzhetongtk_lururq;
	  	}
	    		 		public void setAtzhetongtk_zuihouxgrid(Long atzhetongtk_zuihouxgrid){
			this.atzhetongtk_zuihouxgrid = atzhetongtk_zuihouxgrid;
		}
			 	public Long getAtzhetongtk_zuihouxgrid(){
	  		return atzhetongtk_zuihouxgrid;
	  	}
	    		 		public void setAtzhetongtk_zuihouxgr(String atzhetongtk_zuihouxgr){
			this.atzhetongtk_zuihouxgr = atzhetongtk_zuihouxgr;
		}
			 	public String getAtzhetongtk_zuihouxgr(){
	  		return atzhetongtk_zuihouxgr;
	  	}
	    		 		public void setAtzhetongtk_zuihouxgrq(Timestamp atzhetongtk_zuihouxgrq){
			this.atzhetongtk_zuihouxgrq = atzhetongtk_zuihouxgrq;
		}
			 	public Timestamp getAtzhetongtk_zuihouxgrq(){
	  		return atzhetongtk_zuihouxgrq;
	  	}
	    		 		public void setAtzhetongtk_tkyy(String atzhetongtk_tkyy){
			this.atzhetongtk_tkyy = atzhetongtk_tkyy;
		}
			 	public String getAtzhetongtk_tkyy(){
	  		return atzhetongtk_tkyy;
	  	}
	    		 		public void setAtzhetongtk_yjfhsj(Date atzhetongtk_yjfhsj){
			this.atzhetongtk_yjfhsj = atzhetongtk_yjfhsj;
		}
			 	public Date getAtzhetongtk_yjfhsj(){
	  		return atzhetongtk_yjfhsj;
	  	}
	    		 		public void setAtzhetongtk_glfahuotzd(String atzhetongtk_glfahuotzd){
			this.atzhetongtk_glfahuotzd = atzhetongtk_glfahuotzd;
		}
			 	public String getAtzhetongtk_glfahuotzd(){
	  		return atzhetongtk_glfahuotzd;
	  	}
	    	  	  public Long getAtzhetongtk_id(){
  	  	return atzhetongtk_id;
  	  }
  	  public void setAtzhetongtk_id(Long atzhetongtk_id){
  	  	this.atzhetongtk_id = atzhetongtk_id;
  	  }
	  public Long getId(){
	  	return getAtzhetongtk_id();
	  }
