...
* Author      :Actiz
* Build Time  :2017-11-28 16:11:09.628
*/
...
public class Fdffddea000000005z implements IAppEntityObject{
	private Long atzjiaban_id;
	
			 		private Long atzjiaban_actizversion;
					 			 		private Long atzjiaban_yuangong;
					 		private Long atzjiaban_bumenid;
					 		private Date atzjiaban_jiabanrq;
					 		private Timestamp atzjiaban_jiabankssj;
					 		private Timestamp atzjiaban_jiabanjssj;
					 		private Double atzjiaban_jiabansc = 0.0;
					 		private String atzjiaban_jiabansy;
					 		private String atzjiaban_lurur = "";
					 		private Date atzjiaban_lururq;
					 		private String atzjiaban_zuihouxgr = "";
					 		private Date atzjiaban_zuihouxgrq;
					 		private String atzjiaban_danjuzt = "";
					 		private String atzjiaban_shenhezt = "";
					 		private Long atzjiaban_lururid;
					 		private Long atzjiaban_zuihouxgrid;
					 		private String atzjiaban_sqlx = "";
					 		private Long atzjiaban_shrid;
					 		...
					 		public void setAtzjiaban_actizversion(Long atzjiaban_actizversion){
			this.atzjiaban_actizversion = atzjiaban_actizversion;
		}
			 	public Long getAtzjiaban_actizversion(){
	  		return atzjiaban_actizversion;
	  	}
	    		   		 		public void setAtzjiaban_yuangong(Long atzjiaban_yuangong){
			this.atzjiaban_yuangong = atzjiaban_yuangong;
		}
			 	public Long getAtzjiaban_yuangong(){
	  		return atzjiaban_yuangong;
	  	}
	    		 		public void setAtzjiaban_bumenid(Long atzjiaban_bumenid){
			this.atzjiaban_bumenid = atzjiaban_bumenid;
		}
			 	public Long getAtzjiaban_bumenid(){
	  		return atzjiaban_bumenid;
	  	}
	    		 		public void setAtzjiaban_jiabanrq(Date atzjiaban_jiabanrq){
			this.atzjiaban_jiabanrq = atzjiaban_jiabanrq;
		}
			 	public Date getAtzjiaban_jiabanrq(){
	  		return atzjiaban_jiabanrq;
	  	}
	    		 		public void setAtzjiaban_jiabankssj(Timestamp atzjiaban_jiabankssj){
			this.atzjiaban_jiabankssj = atzjiaban_jiabankssj;
		}
			 	public Timestamp getAtzjiaban_jiabankssj(){
	  		return atzjiaban_jiabankssj;
	  	}
	    		 		public void setAtzjiaban_jiabanjssj(Timestamp atzjiaban_jiabanjssj){
			this.atzjiaban_jiabanjssj = atzjiaban_jiabanjssj;
		}
			 	public Timestamp getAtzjiaban_jiabanjssj(){
	  		return atzjiaban_jiabanjssj;
	  	}
	    		 		public void setAtzjiaban_jiabansc(Double atzjiaban_jiabansc){
			this.atzjiaban_jiabansc = atzjiaban_jiabansc;
		}
			 	public Double getAtzjiaban_jiabansc(){
	  		return atzjiaban_jiabansc;
	  	}
	    		 		public void setAtzjiaban_jiabansy(String atzjiaban_jiabansy){
			this.atzjiaban_jiabansy = atzjiaban_jiabansy;
		}
			 	public String getAtzjiaban_jiabansy(){
	  		return atzjiaban_jiabansy;
	  	}
	    		 		public void setAtzjiaban_lurur(String atzjiaban_lurur){
			this.atzjiaban_lurur = atzjiaban_lurur;
		}
			 	public String getAtzjiaban_lurur(){
	  		return atzjiaban_lurur;
	  	}
	    		 		public void setAtzjiaban_lururq(Date atzjiaban_lururq){
			this.atzjiaban_lururq = atzjiaban_lururq;
		}
			 	public Date getAtzjiaban_lururq(){
	  		return atzjiaban_lururq;
	  	}
	    		 		public void setAtzjiaban_zuihouxgr(String atzjiaban_zuihouxgr){
			this.atzjiaban_zuihouxgr = atzjiaban_zuihouxgr;
		}
			 	public String getAtzjiaban_zuihouxgr(){
	  		return atzjiaban_zuihouxgr;
	  	}
	    		 		public void setAtzjiaban_zuihouxgrq(Date atzjiaban_zuihouxgrq){
			this.atzjiaban_zuihouxgrq = atzjiaban_zuihouxgrq;
		}
			 	public Date getAtzjiaban_zuihouxgrq(){
	  		return atzjiaban_zuihouxgrq;
	  	}
	    		 		public void setAtzjiaban_danjuzt(String atzjiaban_danjuzt){
			this.atzjiaban_danjuzt = atzjiaban_danjuzt;
		}
			 	public String getAtzjiaban_danjuzt(){
	  		return atzjiaban_danjuzt;
	  	}
	    		 		public void setAtzjiaban_shenhezt(String atzjiaban_shenhezt){
			this.atzjiaban_shenhezt = atzjiaban_shenhezt;
		}
			 	public String getAtzjiaban_shenhezt(){
	  		return atzjiaban_shenhezt;
	  	}
	    		 		public void setAtzjiaban_lururid(Long atzjiaban_lururid){
			this.atzjiaban_lururid = atzjiaban_lururid;
		}
			 	public Long getAtzjiaban_lururid(){
	  		return atzjiaban_lururid;
	  	}
	    		 		public void setAtzjiaban_zuihouxgrid(Long atzjiaban_zuihouxgrid){
			this.atzjiaban_zuihouxgrid = atzjiaban_zuihouxgrid;
		}
			 	public Long getAtzjiaban_zuihouxgrid(){
	  		return atzjiaban_zuihouxgrid;
	  	}
	    		 		public void setAtzjiaban_sqlx(String atzjiaban_sqlx){
			this.atzjiaban_sqlx = atzjiaban_sqlx;
		}
			 	public String getAtzjiaban_sqlx(){
	  		return atzjiaban_sqlx;
	  	}
	    		 		public void setAtzjiaban_shrid(Long atzjiaban_shrid){
			this.atzjiaban_shrid = atzjiaban_shrid;
		}
			 	public Long getAtzjiaban_shrid(){
	  		return atzjiaban_shrid;
	  	}
			...
			this.atzemployee_shifoulz = atzemployee_shifoulz;
	  		...
	  		return atzemployee_shifoulz;
	    	  	  ...
	    	  	  public Long getAtzjiaban_id(){
  	  	return atzjiaban_id;
  	  }
  	  public void setAtzjiaban_id(Long atzjiaban_id){
  	  	this.atzjiaban_id = atzjiaban_id;
  	  }
	  public Long getId(){
	  	return getAtzjiaban_id();
	  }
