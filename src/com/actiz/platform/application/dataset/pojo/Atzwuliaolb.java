...
public class Atzwuliaolb implements Serializable,IPojo
{
   ...
   { 	    
      ...
      return this.cengci;     	
 	 	 ...
 	 	 private Long fulbid;
	 public void setFulbid(Long fulbid)
	 {
		  this.fulbid = fulbid;
	 }
   public Long getFulbid()
   { 	    
   ...
   { 	    
	 ...
	 private com.actiz.platform.application.dataset.pojo.Atzwuliaolb fulbidRef;
	 public void setFulbidRef(com.actiz.platform.application.dataset.pojo.Atzwuliaolb fulbidRef)
	 {
		  this.fulbidRef = fulbidRef;
	 }
   public com.actiz.platform.application.dataset.pojo.Atzwuliaolb getFulbidRef()
   {
     	return this.fulbidRef;
   }
