...
public class Atzfahuotzshjl implements Serializable,IPojo
{
   ...
   public Long getId()
   {
	 ...
	 public void setActizversion(Long actizversion)
	 {
		  this.actizversion = actizversion;
	  	 	 ...
	  	 	 private Long atzfahuotzdid;
	 public void setAtzfahuotzdid(Long atzfahuotzdid)
	 {
		  this.atzfahuotzdid = atzfahuotzdid;
	 }
   public Long getAtzfahuotzdid()
   { 	    
  	        
      return this.atzfahuotzdid;     	
   }
   ...
   { 	    
	 ...
	 private com.actiz.platform.application.dataset.pojo.Atzfahuotzd atzfahuotzdidRef;
	 public void setAtzfahuotzdidRef(com.actiz.platform.application.dataset.pojo.Atzfahuotzd atzfahuotzdidRef)
	 {
		  this.atzfahuotzdidRef = atzfahuotzdidRef;
	 }
   public com.actiz.platform.application.dataset.pojo.Atzfahuotzd getAtzfahuotzdidRef()
   {
     	return this.atzfahuotzdidRef;
   }
