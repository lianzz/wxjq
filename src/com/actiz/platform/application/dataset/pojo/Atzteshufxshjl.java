...
public class Atzteshufxshjl implements Serializable,IPojo
{
   ...
   public Long getId()
   {
	 ...
	 public void setActizversion(Long actizversion)
	 {
		  this.actizversion = actizversion;
	  	 	 ...
	  	 	 private Long atzteshufxdid;
	 public void setAtzteshufxdid(Long atzteshufxdid)
	 {
		  this.atzteshufxdid = atzteshufxdid;
	 }
   public Long getAtzteshufxdid()
   { 	    
  	        
      return this.atzteshufxdid;     	
   }
   ...
   { 	    
	 ...
	 private com.actiz.platform.application.dataset.pojo.Atzteshufxd atzteshufxdidRef;
	 public void setAtzteshufxdidRef(com.actiz.platform.application.dataset.pojo.Atzteshufxd atzteshufxdidRef)
	 {
		  this.atzteshufxdidRef = atzteshufxdidRef;
	 }
   public com.actiz.platform.application.dataset.pojo.Atzteshufxd getAtzteshufxdidRef()
   {
     	return this.atzteshufxdidRef;
   }
