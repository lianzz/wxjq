...
public class Atztiaozhang implements Serializable,IPojo
{
   ...
   { 	    
      ...
      return this.churuklx;     	
 	 	 ...
 	 	 private Long tiaozhangzb;
	 public void setTiaozhangzb(Long tiaozhangzb)
	 {
		  this.tiaozhangzb = tiaozhangzb;
	 }
   public Long getTiaozhangzb()
   { 	    
  	        
      return this.tiaozhangzb;     	
   }
   ...
   { 	    
	 ...
	 private com.actiz.platform.application.dataset.pojo.Atztiaozhangzb tiaozhangzbRef;
	 public void setTiaozhangzbRef(com.actiz.platform.application.dataset.pojo.Atztiaozhangzb tiaozhangzbRef)
	 {
		  this.tiaozhangzbRef = tiaozhangzbRef;
	 }
   public com.actiz.platform.application.dataset.pojo.Atztiaozhangzb getTiaozhangzbRef()
   {
     	return this.tiaozhangzbRef;
   }
